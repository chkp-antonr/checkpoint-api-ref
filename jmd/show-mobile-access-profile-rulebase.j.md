...
```json
{
  ...
  "examples": {
    "show-mobile-access-profile-rulebase": {
      "description": "Showing the Mobile Access Profile rulebase",
      "request": "POST {{server}}/show-mobile-access-profile-rulebase\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"offset\" : 0,\n  \"limit\" : 20,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.139549",
    "source_file": "show-mobile-access-profile-rulebase.html"
  }
}
```