...
```json
{
  "command": "show-access-point-names",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-access-point-names",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-access-point-names": {
      "description": "",
      "request": "POST {{server}}/show-access-point-names\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 10\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.479678",
    "source_file": "show-access-point-names.html"
  }
}
```