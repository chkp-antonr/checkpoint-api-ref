...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-group-with-exclusion",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-group-with-exclusion": {
      "description": "",
      "request": "POST {{server}}/add-group-with-exclusion\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Group with exclusion\",\n  \"include\" : \"New Group 1\",\n  \"except\" : \"New Group 2\"\n}",
      "response": ""
    },
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.180720",
    "source_file": "add-group-with-exclusion.html"
  }
}
```