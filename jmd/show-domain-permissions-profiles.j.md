# show-domain-permissions-profiles

```json
{
  "command": "show-domain-permissions-profiles",
  "description": "Retrieve all Domain Permissions Profiles.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-domain-permissions-profiles",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-domain-permissions-profiles": {
      "description": "",
      "request": "POST {{server}}/show-domain-permissions-profiles\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.127138",
    "source_file": "show-domain-permissions-profiles.html"
  }
}
```