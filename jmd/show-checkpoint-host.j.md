...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-checkpoint-host",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-checkpoint-host": {
      "description": "",
      "request": "POST {{server}}/show-checkpoint-host\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"CP Host 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.262825",
    "source_file": "show-checkpoint-host.html"
  }
}
```