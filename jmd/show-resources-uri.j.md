...
```json
{
  "command": "show-resources-uri",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-resources-uri",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-resources-uri": {
      "description": "",
      "request": "POST {{server}}/show-resources-uri\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.225964",
    "source_file": "show-resources-uri.html"
  }
}
```