...
```json
{
  "command": "show-lsm-gateways",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-lsm-gateways",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-lsm-gateways": {
      "description": "",
      "request": "POST {{server}}/show-lsm-gateways\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.995088",
    "source_file": "show-lsm-gateways.html"
  }
}
```