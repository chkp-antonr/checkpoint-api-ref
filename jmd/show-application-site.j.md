...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-application-site",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-application-site": {
      "description": "",
      "request": "POST {{server}}/show-application-site\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"facebook\"\n}",
      "response": ""
    },
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.044849",
    "source_file": "show-application-site.html"
  }
}
```