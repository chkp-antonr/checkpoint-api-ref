...
```json
{
  "command": "set-threat-indicator",
  "description": "Edit an existing Threat-Indicator.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-threat-indicator",
    "headers": [
      {
        "name": "Content-Type",
