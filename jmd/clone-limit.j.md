...
{
  "command": "clone-limit",
  "description": "Clone an existing Limit object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-limit",
    "headers": [
      {
        "name": "Content-Type",
