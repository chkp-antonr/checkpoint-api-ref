...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-address-range",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-address-range": {
      "description": "",
      "request": "POST {{server}}/show-address-range\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Address Range 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.734210",
    "source_file": "show-address-range.html"
  }
}
```