...
```json
{
  "command": "show-smtp-server",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-smtp-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-smtp-server": {
      "description": "",
      "request": "POST {{server}}/show-smtp-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"SMTP\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.472119",
    "source_file": "show-smtp-server.html"
  }
}
```