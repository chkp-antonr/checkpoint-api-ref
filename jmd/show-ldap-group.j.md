...
```json
{
  "command": "show-ldap-group",
  "description": "Retrieve existing LDAP Group using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-ldap-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show ldap-group": {
      "description": "Retrieve existing LDAP group.",
      "request": "POST {{server}}/show-ldap-group\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"TestLdapGroup\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.718236",
    "source_file": "show-ldap-group.html"
  }
}
```