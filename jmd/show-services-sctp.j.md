...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-services-sctp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-services-sctp": {
      "description": "",
      "request": "POST {{server}}/show-services-sctp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": "{\n  \"from\" : 1,\n  \"to\" : 1,\n  \"total\" : 1,\n  \"objects\" : [ {\n    \"uid\" : \"855ef7a1-b44f-4587-9c36-3f4a8c5d12b9\",\n    \"name\" : \"New_SCTP_Service_5\",\n    \"type\" : \"service-sctp\",\n    \"domain\" : {\n      \"domain-type\" : \"domain\",\n      \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\",\n      \"name\" : \"SMC User\"\n    }\n  } ]\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.746904",
    "source_file": "show-services-sctp.html"
  }
}
```