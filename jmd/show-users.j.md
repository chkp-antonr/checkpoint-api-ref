...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-users",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      },
      {
        ...
        "description": "Indicates whether to calculate and show \"certificates\" field in reply when details level is \"full\".",
        "type": "boolean",
        "required": false,
        "default": "false"
      }
  ...
  "examples": {
    "show-users": {
      "description": "",
      "request": "POST {{server}}/show-users\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"details-level\" : \"full\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.339769",
    "source_file": "show-users.html"
  }
}
```