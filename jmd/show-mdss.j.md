...
{
  "command": "show-mdss",
  "description": "Retrieve all objects of type Multi-Domain Server or Multi-Domain Log Server.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-mdss",
    "headers": [
      {
        "name": "Content-Type",
