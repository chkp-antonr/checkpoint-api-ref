...
```json
{
  "command": "show-trusted-client",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-trusted-client",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-trusted-client": {
      "description": "",
      "request": "POST {{server}}/show-trusted-client\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"anyHost\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.138702",
    "source_file": "show-trusted-client.html"
  }
}
```