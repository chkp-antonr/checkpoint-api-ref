...
```json
{
  "command": "clone-radius-group",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-radius-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone radius-group": {
      "description": "Clone radius group",
      "request": "POST {{server}}/clone-radius-group\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"group1\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.028857",
    "source_file": "clone-radius-group.html"
  }
}
```