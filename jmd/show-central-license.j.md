...
```json
{
  "command": "show-central-license",
  "description": "Show given license.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-central-license",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      {
        "name": "signature",
        "description": "The license's signature.",
        "type": "string",
        "required": false
      }
    ]
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.159742",
    "source_file": "show-central-license.html"
  }
}
```