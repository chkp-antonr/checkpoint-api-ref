...
```json
{
  "command": "add-threat-protections",
  "description": "Adds threat protections.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-threat-protections",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-threat-protections": {
      ...
      "request": "POST {{server}}/add-threat-protections\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"package-path\" : \"/path/to/community.rules\",\n  \"package-format\" : \"snort\"\n}",
      "response": "{\n  \"task-id\" : \"6b2e5c77-0622-4e7f-a9bf-4e1f21899553\"\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:09.814146",
    "source_file": "add-threat-protections.html"
  }
}
```