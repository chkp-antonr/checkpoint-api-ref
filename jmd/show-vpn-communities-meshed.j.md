...
```json
{
  "command": "show-vpn-communities-meshed",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-vpn-communities-meshed",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-vpn-communities-meshed": {
      ...
      "request": "POST {{server}}/show-vpn-communities-meshed\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"full\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.379239",
    "source_file": "show-vpn-communities-meshed.html"
  }
}
```