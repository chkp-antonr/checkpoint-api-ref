...
```json
{
  "command": "clone-resource-smtp",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-resource-smtp",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "mail-delivery-server",
        "description": "Specify the server to which mail is forwarded.",
        "type": "string",
        "required": false
      },
      {
        "name": "deliver-messages-using-dns-mx-records",
      ...
      {
        "name": "check-rulebase-with-new-destination",
      ...
      {
        "name": "error-mail-delivery-server",
      ...
      {
        "name": "error-deliver-messages-using-dns-mx-records",
      ...
      {
        "name": "error-check-rulebase-with-new-destination",
  ...
  "examples": {
    "clone-resource-smtp": {
      "description": "",
      "request": "POST {{server}}/clone-resource-smtp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"apismtp\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.168370",
    "source_file": "clone-resource-smtp.html"
  }
}
```