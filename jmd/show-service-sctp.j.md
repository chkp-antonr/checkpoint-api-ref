...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-service-sctp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-service-sctp": {
      "description": "",
      "request": "POST {{server}}/show-service-sctp\nX-chkp-sid: {{session}}\nContent-Type: application/json\n\n{\n  \"name\" : \"New_SCTP_Service_1\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.584539",
    "source_file": "show-service-sctp.html"
  }
}
```