...
```json
{
  "command": "set-global-assignment",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-global-assignment",
    "headers": [
      {
        "name": "Content-Type",
