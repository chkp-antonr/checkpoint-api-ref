# set-gsn-handover-group

```json
{
  "command": "set-gsn-handover-group",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-gsn-handover-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:17.265660",
    "source_file": "set-gsn-handover-group.html"
  }
}
```