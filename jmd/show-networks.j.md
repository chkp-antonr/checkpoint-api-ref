...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-networks",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-networks": {
      "description": "",
      "request": "POST {{server}}/show-networks\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    },
    "show networks using filter": {
      "description": "Show networks using filter.",
      "request": "POST {{server}}/show-networks\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"filter\" : \"network_\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.521433",
    "source_file": "show-networks.html"
  }
}
```