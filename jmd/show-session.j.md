...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-session",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-session": {
      "description": "",
      "request": "POST {{server}}/show-session\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.823594",
    "source_file": "show-session.html"
  }
}
```