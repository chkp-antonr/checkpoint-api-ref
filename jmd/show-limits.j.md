...
{
  "command": "show-limits",
  "description": "Retrieve all Limit objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-limits",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-limits": {
      "description": "",
      "request": "POST {{server}}/show-limits\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.756371",
    "source_file": "show-limits.html"
  }
}
```