...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-threat-protections",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "show-capture-packets-and-track",
      ...
      {
        "name": "show-ips-additional-properties",
  ...
  "examples": {
    "show-threat-protections": {
      "description": "",
      "request": "POST {{server}}/show-threat-protections\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.942581",
    "source_file": "show-threat-protections.html"
  }
}
```