...
```json
{
  ...
  "description": "Switch to a disconnected Management API session of the same administrator. To switch to an open session or to a session of a different administrator use the take-over session API.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/switch-session",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "switch-session": {
      "description": "",
      "request": "POST {{server}}/switch-session\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.822895",
    "source_file": "switch-session.html"
  }
}
```