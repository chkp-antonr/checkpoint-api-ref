...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-security-zones",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-security-zones": {
      ...
      "request": "POST {{server}}/show-security-zones\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.317795",
    "source_file": "show-security-zones.html"
  }
}
```