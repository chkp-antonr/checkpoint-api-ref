...
```json
{
  "command": "show-smart-tasks",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-smart-tasks",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-smart-tasks": {
      "description": "",
      "request": "POST {{server}}/show-smart-tasks\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.456552",
    "source_file": "show-smart-tasks.html"
  }
}
```