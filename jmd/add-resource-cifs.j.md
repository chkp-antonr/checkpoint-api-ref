...
```json
{
  "command": "add-resource-cifs",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-resource-cifs",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.394265",
    "source_file": "add-resource-cifs.html"
  }
}
```