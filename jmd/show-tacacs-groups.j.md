...
```json
{
  "command": "show-tacacs-groups",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-tacacs-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-tacacs-groups": {
      "description": "",
      "request": "POST {{server}}/show-tacacs-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.578838",
    "source_file": "show-tacacs-groups.html"
  }
}
```