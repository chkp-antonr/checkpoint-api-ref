...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-threat-protection",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-threat-protection": {
      "description": "",
      "request": "POST {{server}}/show-threat-protection\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"FTP Commands\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.929492",
    "source_file": "show-threat-protection.html"
  }
}
```