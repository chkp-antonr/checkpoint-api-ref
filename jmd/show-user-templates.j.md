...
```json
{
  "command": "show-user-templates",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-user-templates",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-user-templates": {
      "description": "",
      "request": "POST {{server}}/show-user-templates\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"details-level\" : \"full\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.290726",
    "source_file": "show-user-templates.html"
  }
}
```