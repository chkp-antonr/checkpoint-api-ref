...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/assign-session",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "assign-session": {
      ...
      "request": "POST {{server}}/assign-session\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:10.561827",
    "source_file": "assign-session.html"
  }
}
```