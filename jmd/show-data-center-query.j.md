...
```json
{
  "command": "show-data-center-query",
  "description": "Retrieves data center query.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-center-query",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-center-query": {
      "description": "",
      "request": "POST {{server}}/show-data-center-query\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"data-center-query1\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.646974",
    "source_file": "show-data-center-query.html"
  }
}
```