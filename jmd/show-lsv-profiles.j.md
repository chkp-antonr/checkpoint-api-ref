...
```json
{
  "command": "show-lsv-profiles",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-lsv-profiles",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show lsv-profiles": {
      "description": "Display all LSV Profiles",
      "request": "POST {{server}}/show-lsv-profiles\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.029896",
    "source_file": "show-lsv-profiles.html"
  }
}
```