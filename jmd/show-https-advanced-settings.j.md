...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-https-advanced-settings",
    "headers": [
      {
        "name": "Content-Type",
