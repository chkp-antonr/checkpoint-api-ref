...
```json
{
  "command": "show-syslog-servers",
  "description": "Retrieve all syslog servers.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-syslog-servers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show syslog-servers": {
      "description": "Shows syslog servers.",
      "request": "POST {{server}}/show-syslog-servers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 5,\n  \"offset\" : 0,\n  \"details-level\" : \"full\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.546264",
    "source_file": "show-syslog-servers.html"
  }
}
```