...
```json
{
  "command": "add-opsec-application",
  "description": "Create a new OPSEC Application. At least one client entity (LEA, CPMI) must be supplied.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-opsec-application",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "use-administrator-credentials",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.166516",
    "source_file": "add-opsec-application.html"
  }
}
```