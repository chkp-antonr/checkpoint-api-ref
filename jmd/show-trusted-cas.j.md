...
```json
{
  "command": "show-trusted-cas",
  "description": "Retrieve all types of Trusted CA objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-trusted-cas",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show trusted-cas": {
      "description": "Show trusted cas",
      "request": "POST {{server}}/show-trusted-cas\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.118172",
    "source_file": "show-trusted-cas.html"
  }
}
```