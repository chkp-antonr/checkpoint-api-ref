...
```json
{
  "command": "show-resources-ftp",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-resources-ftp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-resources-ftp": {
      "description": "",
      "request": "POST {{server}}/show-resources-ftp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.151655",
    "source_file": "show-resources-ftp.html"
  }
}
```