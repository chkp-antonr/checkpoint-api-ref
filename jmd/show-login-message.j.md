...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-login-message",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-login-message": {
      "description": "",
      "request": "POST {{server}}/show-login-message\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.802305",
    "source_file": "show-login-message.html"
  }
}
```