...
```json
{
  "command": "set-azure-ad",
  "description": "Edit existing Microsoft Entra ID object (formerly, Azure AD). Microsoft Entra ID is Microsoft's cloud-based identity and access management service.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-azure-ad",
    "headers": [
      {
        "name": "Content-Type",
