...
```json
{
  "command": "add-threat-indicator",
  "description": "Create a new Threat-Indicator.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-threat-indicator",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-threat-indicator": {
      ...
      "request": "POST {{server}}/add-threat-indicator\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"My_Indicator\",\n  \"observables\" : [ {\n    \"name\" : \"My_Observable\",\n    \"mail-to\" : \"someone@somewhere.com\",\n    \"confidence\" : \"medium\",\n    \"severity\" : \"low\",\n    \"product\" : \"AV\"\n  } ],\n  \"action\" : \"ask\",\n  \"profile-overrides\" : [ {\n    \"profile\" : \"My_Profile\",\n    \"action\" : \"detect\"\n  } ],\n  \"ignore-warnings\" : true\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:09.713694",
    "source_file": "add-threat-indicator.html"
  }
}
```