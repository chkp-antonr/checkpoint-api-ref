...
```json
{
  "command": "show-dns-domains",
  "description": "Retrieve all existing Domain objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-dns-domains",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-dns-domains": {
      "description": "",
      "request": "POST {{server}}/show-dns-domains\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": "{\n  \"from\" : 1,\n  \"to\" : 1,\n  \"total\" : 1,\n  \"objects\" : [ {\n    \"uid\" : \"ab7aa902-ccac-4278-b4eb-c140c07c6170\",\n    \"name\" : \".www.example.com\",\n    \"type\" : \"dns-domain\",\n    \"domain\" : {\n      \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\",\n      \"name\" : \"SMC User\",\n      \"domain-type\" : \"domain\"\n    }\n  } ]\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.056873",
    "source_file": "show-dns-domains.html"
  }
}
```