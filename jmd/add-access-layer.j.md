...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-access-layer",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-access-layer": {
      ...
      "request": "POST {{server}}/add-access-layer\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Layer 1\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:35:14.395370",
    "source_file": "add-access-layer.html"
  }
}
```