...
```json
{
  "command": "clone-resource-mms",
  "description": "Clone existing MMS resource.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-resource-mms",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-resource-mms": {
      "description": "",
      "request": "POST {{server}}/clone-resource-mms\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newMmsResource\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.127799",
    "source_file": "clone-resource-mms.html"
  }
}
```