...
```json
{
  "command": "show-interoperable-devices",
  "description": "Retrieve all Interoperable Devices.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-interoperable-devices",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-interoperable-devices": {
      "description": "Shows all interoperable devices",
      "request": "POST {{server}}/show-interoperable-devices\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
    ...
    "show-interoperable-devices using filter": {
      "description": "Shows all interoperable devices with a specific filter",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.596884",
    "source_file": "show-interoperable-devices.html"
  }
}
```