...
```json
{
  "command": "show-radius-servers",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-radius-servers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-radius-servers": {
      "description": "Show radius servers",
      "request": "POST {{server}}/show-radius-servers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 4,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.933002",
    "source_file": "show-radius-servers.html"
  }
}
```