...
```json
{
  "command": "set-resource-tcp",
  "description": "Edit existing TCP resource using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-resource-tcp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.982531",
    "source_file": "set-resource-tcp.html"
  }
}
```