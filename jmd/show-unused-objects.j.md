...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-unused-objects",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show unused objects": {
      ...
      "request": "POST {{server}}/show-unused-objects\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"offset\" : 0,\n  \"limit\" : 50,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.162370",
    "source_file": "show-unused-objects.html"
  }
}
```