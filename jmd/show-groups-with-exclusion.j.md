...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-groups-with-exclusion",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-groups-with-exclusion": {
      "description": "",
      "request": "POST {{server}}/show-groups-with-exclusion\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    },
    "show-groups-with-exclusion as ranges": {
      "description": "Shows the first 50 groups with exclusion with each group with exclusion's matched content displayed as ranges of IP addresses, and not as Check Point Objects.",
      "request": "POST {{server}}/show-groups-with-exclusion\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"full\",\n  \"show-as-ranges\" : \"true\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.907608",
    "source_file": "show-groups-with-exclusion.html"
  }
}
```