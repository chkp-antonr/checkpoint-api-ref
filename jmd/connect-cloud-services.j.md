...
```json
{
  ...
  "description": "Securely connect the Management Server to Check Point's Infinity Portal. This is a preliminary operation so that the management server can use various Check Point cloud-based security services hosted in the Infinity Portal.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/connect-cloud-services",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    ...
    "connect-cloud-services with edit of Gateways On-boarding Settings": {
      "description": "Connect the management server to Check Point Smart-1 Cloud services and edit Gateways On-boarding Settings.",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:14.144552",
    "source_file": "connect-cloud-services.html"
  }
}
```