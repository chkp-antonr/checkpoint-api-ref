# clone-service-compound-tcp

```json
{
  "command": "clone-service-compound-tcp",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-service-compound-tcp",
    "headers": [
      {
        "name": "Content-Type",
