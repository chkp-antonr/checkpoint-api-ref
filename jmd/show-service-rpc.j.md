...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-service-rpc",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-service-rpc": {
      "description": "",
      "request": "POST {{server}}/show-service-rpc\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"nisplus\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.565546",
    "source_file": "show-service-rpc.html"
  }
}
```