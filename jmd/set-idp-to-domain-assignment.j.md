...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-idp-to-domain-assignment",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    ...
    "set idp-to-domain-assignment of domain to use default idp-to-domain-assignment": {
      "description": "set idp-to-domain-assignment of domain to use default idp-to-domain-assignment",
      "request": "POST {{server}}/set-idp-to-domain-assignment\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"assigned-domain\" : \"BSMS\",\n  \"using-default\" : \"true\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:17.622719",
    "source_file": "set-idp-to-domain-assignment.html"
  }
}
```