...
```json
{
  "command": "show-dynamic-object",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-dynamic-object",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-dynamic-object": {
      ...
      "request": "POST {{server}}/show-dynamic-object\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Dynamic_Object_1\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.263742",
    "source_file": "show-dynamic-object.html"
  }
}
```