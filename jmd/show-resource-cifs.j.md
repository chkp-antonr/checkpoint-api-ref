...
```json
{
  "command": "show-resource-cifs",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-resource-cifs",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-resource-cifs": {
      "description": "",
      "request": "POST {{server}}/show-resource-cifs\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newCifsResource\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.989807",
    "source_file": "show-resource-cifs.html"
  }
}
```