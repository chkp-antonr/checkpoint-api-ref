...
```json
{
  "command": "show-multiple-key-exchanges",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-multiple-key-exchanges",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-multiple-key-exchanges": {
      "description": "Show an existing Multiple Key Exchanges.",
      "request": "POST {{server}}/show-multiple-key-exchanges\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Multiple Key Exchanges\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.324074",
    "source_file": "show-multiple-key-exchanges.html"
  }
}
```