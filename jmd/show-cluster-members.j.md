...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-cluster-members",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-cluster-members": {
      "description": "",
      "request": "POST {{server}}/show-cluster-members\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 5,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.421915",
    "source_file": "show-cluster-members.html"
  }
}
```