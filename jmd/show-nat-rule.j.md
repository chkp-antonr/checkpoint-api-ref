...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-nat-rule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-nat-rule": {
      "description": "",
      "request": "POST {{server}}/show-nat-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"rule-number\" : 1,\n  \"package\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.360605",
    "source_file": "show-nat-rule.html"
  }
}
```