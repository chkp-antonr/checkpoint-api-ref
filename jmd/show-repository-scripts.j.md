...
```json
{
  "command": "show-repository-scripts",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-repository-scripts",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-repository-scripts": {
      "description": "",
      "request": "POST {{server}}/show-repository-scripts\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.975176",
    "source_file": "show-repository-scripts.html"
  }
}
```