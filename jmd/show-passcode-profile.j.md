...
```json
{
  "command": "show-passcode-profile",
  "description": "Retrieve existing Passcode Profile using name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-passcode-profile",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-passcode-profile": {
      "description": "Showing a Passcode profile",
      "request": "POST {{server}}/show-passcode-profile\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"My App Passcode Policy\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.776630",
    "source_file": "show-passcode-profile.html"
  }
}
```