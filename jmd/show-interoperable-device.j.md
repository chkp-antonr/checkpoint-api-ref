...
```json
{
  "command": "show-interoperable-device",
  "description": "Retrieves existing Interoperable Device.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-interoperable-device",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-interoperable-device": {
      "description": "Shows a simple Interoperable Device",
      "request": "POST {{server}}/show-interoperable-device\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"NewInteroperableDevice\"\n}",
    ...
    "show-interoperable-device with interface": {
      "description": "Shows an Interoperable Device with interface",
      "request": "POST {{server}}/show-interoperable-device\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"NewInteroperableDevice\"\n}",
    ...
    "show-interoperable-device with vpn-domain": {
      "description": "Shows an Interoperable Device with vpn-domain",
      "request": "POST {{server}}/show-interoperable-device\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"NewInteroperableDevice\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.583935",
    "source_file": "show-interoperable-device.html"
  }
}
```