...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-multicast-address-ranges",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-multicast-address-ranges": {
      ...
      "request": "POST {{server}}/show-multicast-address-ranges\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"details-level\" : \"full\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.292924",
    "source_file": "show-multicast-address-ranges.html"
  }
}
```