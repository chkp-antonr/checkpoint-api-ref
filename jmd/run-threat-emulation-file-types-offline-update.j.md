...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/run-threat-emulation-file-types-offline-update",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "run-threat-emulation-file-types-offline-update": {
      ...
      "request": "POST {{server}}/run-threat-emulation-file-types-offline-update\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"file-path\" : \"/tmp/FileTypeUpdate.xml\"\n}",
      "response": "{\n  \"message\" : \"Update of file types supported by Threat Emulation completed successfully.\"\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.681360",
    "source_file": "run-threat-emulation-file-types-offline-update.html"
  }
}
```