...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/delete-repository-package",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "response": {
    "success": [
      {
        "name": "task-id",
        "description": "Unique identifier of the 'delete-repository-package' task. Use the 'show-task' command to check the progress of the task.",
        "type": "string",
        "required": false
      }
    ],
  ...
  "examples": {
    "delete-repository-package": {
      "description": "",
      "request": "POST {{server}}/delete-repository-package\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Check_Point_R80_20_JUMBO_HF_Bundle_T118_sk137592_Security_Gateway_and_Standalone_2_6_18_FULL.tgz\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:14.866663",
    "source_file": "delete-repository-package.html"
  }
}
```