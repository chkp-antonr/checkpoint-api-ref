...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-nat-rule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-nat-rule": {
      "description": "",
      "request": "POST {{server}}/set-nat-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"rule-number\" : 1,\n  \"package\" : \"standard\",\n  \"enabled\" : false,\n  \"original-service\" : \"ssh_version_2\",\n  \"original-source\" : \"Any\",\n  \"comments\" : \"rule for RND members  RNDNetwork-> RND to Internal Network\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.453925",
    "source_file": "set-nat-rule.html"
  }
}
```