...
```json
{
  "command": "set-identity-tag",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-identity-tag",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-identity-tag": {
      "description": "",
      "request": "POST {{server}}/set-identity-tag\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"mytag\",\n  \"external-identifier\" : \"Cisco ISE security group tag\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:17.566419",
    "source_file": "set-identity-tag.html"
  }
}
```