...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-application-site-category",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-application-site-category": {
      "description": "",
      "request": "POST {{server}}/show-application-site-category\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Social Networking\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.970765",
    "source_file": "show-application-site-category.html"
  }
}
```