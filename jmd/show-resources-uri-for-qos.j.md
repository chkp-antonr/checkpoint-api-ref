# show-resources-uri-for-qos

```json
{
  "command": "show-resources-uri-for-qos",
  "description": "Shows a list of all Uri For QoS resources.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-resources-uri-for-qos",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-resources-uri-for-qos": {
      "description": "",
      "request": "POST {{server}}/show-resources-uri-for-qos\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.212541",
    "source_file": "show-resources-uri-for-qos.html"
  }
}
```