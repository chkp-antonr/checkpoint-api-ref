# show-securemote-dns-server

```json
{
  "command": "show-securemote-dns-server",
  "description": "Retrieve existing SecuRemote DNS server using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-securemote-dns-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show securemote dns server": {
      "description": "Retrieve existing Securemote DNS server.",
      "request": "POST {{server}}/show-securemote-dns-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"TestSecuRemoteDNSSever\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.244402",
    "source_file": "show-securemote-dns-server.html"
  }
}
```