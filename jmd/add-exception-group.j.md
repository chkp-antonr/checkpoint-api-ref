...
```json
{
  "command": "add-exception-group",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-exception-group",
    "headers": [
      {
        "name": "Content-Type",
