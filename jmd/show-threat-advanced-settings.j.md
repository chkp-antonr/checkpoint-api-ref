...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-threat-advanced-settings",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-threat-advanced-settings": {
      "description": "Showing Threat Advanced Settings",
      "request": "POST {{server}}/show-threat-advanced-settings\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.721126",
    "source_file": "show-threat-advanced-settings.html"
  }
}
```