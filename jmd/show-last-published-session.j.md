...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-last-published-session",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-last-published-session": {
      ...
      "request": "POST {{server}}/show-last-published-session\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.668720",
    "source_file": "show-last-published-session.html"
  }
}
```