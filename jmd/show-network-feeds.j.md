...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-network-feeds",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-network-feeds": {
      "description": "Showing a list of Network Feeds",
      "request": "POST {{server}}/show-network-feeds\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": "{\n  \"from\" : 1,\n  \"to\" : 1,\n  \"total\" : 1,\n  \"objects\" : [ {\n    \"uid\" : \"a1d2454c-d3cb-439e-9b29-c447b1cafd48\",\n    \"name\" : \"network_feed\",\n    \"type\" : \"network-feed\",\n    \"domain\" : {\n      \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\",\n      \"name\" : \"SMC User\",\n      \"domain-type\" : \"domain\"\n    },\n    \"icon\" : \"General/globalsNa\",\n    \"color\" : \"black\"\n  } ]\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.442483",
    "source_file": "show-network-feeds.html"
  }
}
```