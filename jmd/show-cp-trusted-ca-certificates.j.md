...
```json
{
  "command": "show-cp-trusted-ca-certificates",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-cp-trusted-ca-certificates",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-cp-trusted-ca-certificates": {
      "description": "",
      "request": "POST {{server}}/show-cp-trusted-ca-certificates\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : \"3\",\n  \"order.1.ASC\" : \"status\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.494054",
    "source_file": "show-cp-trusted-ca-certificates.html"
  }
}
```