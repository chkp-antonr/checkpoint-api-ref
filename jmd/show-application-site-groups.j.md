...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-application-site-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-application-site-groups": {
      "description": "",
      "request": "POST {{server}}/show-application-site-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.016106",
    "source_file": "show-application-site-groups.html"
  }
}
```