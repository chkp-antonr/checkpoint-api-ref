...
```json
{
  ...
  "description": "Edit existing Remote Access object. Using object name or uid is optional. Add and Delete API commands for this object are unavailable since there is single object per domain.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-vpn-community-remote-access",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-vpn-community-remote-access": {
      "description": "",
      "request": "POST {{server}}/set-vpn-community-remote-access\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"user-groups\" : [ \"myusergroup\" ],\n  \"gateways\" : [ \"mygateway\" ]\n}",
    ...
    "set-vpn-community-remote-access (with override vpn domains)": {
      "description": "Edits remote access VPN community with override VPN domains.",
      "request": "POST {{server}}/set-vpn-community-remote-access\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"gateways\" : \"gw1\",\n  \"override-vpn-domains\" : [ {\n    \"gateway\" : \"gw1\",\n    \"vpn-domain\" : \"CP_default_Office_Mode_addresses_pool\"\n  } ]\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:21.868508",
    "source_file": "set-vpn-community-remote-access.html"
  }
}
```