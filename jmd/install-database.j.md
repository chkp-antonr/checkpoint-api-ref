...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/install-database",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "install-database": {
      "description": "",
      "request": "POST {{server}}/install-database\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"targets\" : [ \"checkpointhost1\", \"checkpointhost2\" ]\n}",
      "response": "{\n  \"tasks\" : [ {\n    \"target\" : \"checkpointhost1\",\n    \"task-id\" : \"f4f16175-00ba-4478-9439-a2181d96c446\"\n  }, {\n    \"target\" : \"checkpointhost2\",\n    \"task-id\" : \"f4f16175-00ba-4478-9439-a2181d96c556\"\n  } ]\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.481423",
    "source_file": "install-database.html"
  }
}
```