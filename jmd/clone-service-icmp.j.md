...
```json
{
  "command": "clone-service-icmp",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-service-icmp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-service-icmp": {
      "description": "",
      "request": "POST {{server}}/clone-service-icmp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"icmp1\",\n  \"new-name\" : \"icmp2\",\n  \"icmp-type\" : 45,\n  \"icmp-code\" : 13\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.505338",
    "source_file": "clone-service-icmp.html"
  }
}
```