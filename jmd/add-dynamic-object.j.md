...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-dynamic-object",
    "headers": [
      {
        "name": "Content-Type",
