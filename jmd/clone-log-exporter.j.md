...
```json
{
  "command": "clone-log-exporter",
  "description": "Clone existing log exporter.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-log-exporter",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone log-exporter": {
      "description": "Clone existing log exporter.",
      "request": "POST {{server}}/clone-log-exporter\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newLogExporter\",\n  \"target-port\" : \"9306\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.854123",
    "source_file": "clone-log-exporter.html"
  }
}
```