...
```json
{
  "command": "clone-user-group",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-user-group",
    "headers": [
      {
        "name": "Content-Type",
