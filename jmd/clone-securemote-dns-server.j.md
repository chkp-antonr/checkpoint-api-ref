...
```json
{
  "command": "clone-securemote-dns-server",
  "description": "Clone existing SecuRemote DNS server.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-securemote-dns-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone securemote dns server": {
      "description": "Clone existing Securemote DNS server.",
      "request": "POST {{server}}/clone-securemote-dns-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"TestSecuRemoteDNSSever\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.291194",
    "source_file": "clone-securemote-dns-server.html"
  }
}
```