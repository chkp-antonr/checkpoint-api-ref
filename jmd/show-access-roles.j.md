...
```json
{
  "command": "show-access-roles",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-access-roles",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-access-roles": {
      ...
      "request": "POST {{server}}/show-access-roles\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"details-level\" : \"full\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.534706",
    "source_file": "show-access-roles.html"
  }
}
```