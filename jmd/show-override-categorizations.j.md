# show-override-categorizations

```json
{
  "command": "show-override-categorizations",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-override-categorizations",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-override-categorizations": {
      "description": "",
      "request": "POST {{server}}/show-override-categorizations\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.709582",
    "source_file": "show-override-categorizations.html"
  }
}
```