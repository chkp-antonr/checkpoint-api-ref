...
```json
{
  "command": "add-access-role",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-access-role",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-access-role": {
      "description": "",
      "request": "POST {{server}}/add-access-role\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Access Role 1\",\n  \"networks\" : \"any\",\n  \"users\" : \"any\",\n  \"machines\" : \"all identified\",\n  \"remote-access-clients\" : \"any\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.334272",
    "source_file": "add-access-role.html"
  }
}
```