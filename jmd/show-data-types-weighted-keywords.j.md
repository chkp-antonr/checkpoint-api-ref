...
```json
{
  "command": "show-data-types-weighted-keywords",
  "description": "Retrieve all Weighted Keywords Data Type objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-types-weighted-keywords",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-types-weighted-keywords": {
      "description": "",
      "request": "POST {{server}}/show-data-types-weighted-keywords\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 5\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.014323",
    "source_file": "show-data-types-weighted-keywords.html"
  }
}
```