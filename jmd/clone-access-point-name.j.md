...
```json
{
  "command": "clone-access-point-name",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-access-point-name",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.230714",
    "source_file": "clone-access-point-name.html"
  }
}
```