...
```json
{
  ...
  "description": "Delete existing network interface using object uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/delete-interface",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "delete interface": {
      ...
      "request": "POST {{server}}/delete-interface\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"uid\" : \"b7a5cb6f-1ad3-4193-b1ea-dda41308f79c\"\n}",
      "response": "{\n  \"message\" : \"OK\"\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:14.596061",
    "source_file": "delete-interface.html"
  }
}
```