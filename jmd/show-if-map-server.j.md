...
```json
{
  "command": "show-if-map-server",
  "description": "Retrieve existing IF-MAP server using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-if-map-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show if-map-server": {
      "description": "Retrieve existing IF-MAP server.",
      "request": "POST {{server}}/show-if-map-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"TestIfMapServer\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.407298",
    "source_file": "show-if-map-server.html"
  }
}
```