...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-service-icmp6",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-service-icmp6": {
      "description": "",
      "request": "POST {{server}}/show-service-icmp6\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"echo-reply6\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.524851",
    "source_file": "show-service-icmp6.html"
  }
}
```