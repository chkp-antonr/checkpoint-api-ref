...
```json
{
  "command": "show-resources-tcp",
  "description": "Retrieve all TCP resource.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-resources-tcp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-resources-tcp": {
      "description": "",
      "request": "POST {{server}}/show-resources-tcp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.198410",
    "source_file": "show-resources-tcp.html"
  }
}
```