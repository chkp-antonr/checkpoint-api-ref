...
```json
{
  "command": "add-mobile-access-profile-rule",
  "description": "Create new Mobile Access Profile rule for associating groups of users with a profile configuration.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-mobile-access-profile-rule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-mobile-access-profile-rule": {
      "description": "",
      "request": "POST {{server}}/add-mobile-access-profile-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"position\" : 1,\n  \"name\" : \"Rule 1\",\n  \"mobile-profile\" : \"Default_Profile\",\n  \"user-groups\" : [ \"my_group\" ]\n}",
      "response": ""
    },
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.823117",
    "source_file": "add-mobile-access-profile-rule.html"
  }
}
```