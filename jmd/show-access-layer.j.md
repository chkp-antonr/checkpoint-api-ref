...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-access-layer",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "response": {
    "success": [
      ...
      {
        "name": "applications-and-url-filtering",
  ...
  "examples": {
    "show-access-layer": {
      "description": "",
      "request": "POST {{server}}/show-access-layer\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Layer 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.412286",
    "source_file": "show-access-layer.html"
  }
}
```