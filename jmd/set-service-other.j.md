...
```json
{
  "command": "set-service-other",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-service-other",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-service-other": {
      "description": "",
      "request": "POST {{server}}/set-service-other\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New_Service_1\",\n  \"new-name\" : \"New_Service_3\",\n  \"color\" : \"green\",\n  \"aggressive-aging\" : {\n    \"default-timeout\" : 3600\n  }\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:19.362148",
    "source_file": "set-service-other.html"
  }
}
```