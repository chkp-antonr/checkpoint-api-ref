...
```json
{
  "command": "clone-syslog-server",
  "description": "Clone existing syslog server.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-syslog-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone syslog-server": {
      "description": "Clones syslog server.",
      "request": "POST {{server}}/clone-syslog-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newSyslogServer\",\n  \"port\" : \"1000\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.793939",
    "source_file": "clone-syslog-server.html"
  }
}
```