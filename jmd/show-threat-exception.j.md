...
```json
{
  "command": "show-threat-exception",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-threat-exception",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-threat-exception": {
      "description": "",
      "request": "POST {{server}}/show-threat-exception\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"rule-number\" : 1,\n  \"exception-number\" : 1,\n  \"layer\" : \"New Layer 1\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.759464",
    "source_file": "show-threat-exception.html"
  }
}
```