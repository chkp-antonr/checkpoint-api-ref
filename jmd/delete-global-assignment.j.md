...
```json
{
  "command": "delete-global-assignment",
  "description": "Delete existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/delete-global-assignment",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "delete-global-assignment": {
      "description": "",
      "request": "POST {{server}}/delete-global-assignment\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"global-domain\" : \"Global2\",\n  \"dependent-domain\" : \"domain1\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:14.461957",
    "source_file": "delete-global-assignment.html"
  }
}
```