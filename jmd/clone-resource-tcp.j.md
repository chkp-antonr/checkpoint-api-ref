...
```json
{
  "command": "clone-resource-tcp",
  "description": "Clone existing TCP resource.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-resource-tcp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-resource-tcp": {
      "description": "",
      "request": "POST {{server}}/clone-resource-tcp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"tcpResource\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.195334",
    "source_file": "clone-resource-tcp.html"
  }
}
```