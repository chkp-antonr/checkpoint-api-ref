...
```json
{
  "command": "clone-securid-server",
  "description": "Clone existing SecurID server.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-securid-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone securid-server": {
      "description": "Clones SecurID server",
      "request": "POST {{server}}/clone-securid-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"TestSecurIdServer\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.306989",
    "source_file": "clone-securid-server.html"
  }
}
```