...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/disconnect-cloud-services",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "disconnect-cloud-services": {
      "description": "Disconnect the management server from Check Point Smart-1 Cloud services.",
      "request": "POST {{server}}/disconnect-cloud-services\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": "{\n  \"message\" : \"OK\"\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.339331",
    "source_file": "disconnect-cloud-services.html"
  }
}
```