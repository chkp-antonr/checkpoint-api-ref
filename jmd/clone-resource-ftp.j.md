...
```json
{
  "command": "clone-resource-ftp",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-resource-ftp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-resource-ftp": {
      "description": "",
      "request": "POST {{server}}/clone-resource-ftp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"myftp\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.110833",
    "source_file": "clone-resource-ftp.html"
  }
}
```