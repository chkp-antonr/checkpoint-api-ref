...
```json
{
  "command": "show-user-groups",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-user-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-user-groups": {
      "description": "",
      "request": "POST {{server}}/show-user-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"details-level\" : \"full\"\n}",
      "response": "{\n  \"from\" : 1,\n  \"to\" : 1,\n  \"total\" : 1,\n  \"objects\" : [ {\n    \"uid\" : \"8c7eb5af-0a27-43f8-a83c-bc38e900e75c\",\n    \"name\" : \"myusergroup\",\n    \"type\" : \"user-group\",\n    \"domain\" : {\n      \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\",\n      \"name\" : \"SMC User\",\n      \"domain-type\" : \"domain\"\n    },\n    \"icon\" : \"Objects/UsersGroup\",\n    \"color\" : \"black\"\n  } ]\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.240000",
    "source_file": "show-user-groups.html"
  }
}
```