...
```json
{
  ...
  "description": "Edit API settings, the changes will be applied after publish followed by running 'api restart' command.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-api-settings",
    "headers": [
      {
        "name": "Content-Type",
