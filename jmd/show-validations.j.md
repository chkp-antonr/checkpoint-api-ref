...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-validations",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-validations": {
      ...
      "request": "POST {{server}}/show-validations\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.366326",
    "source_file": "show-validations.html"
  }
}
```