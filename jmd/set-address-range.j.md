...
```json
{
  "command": "set-address-range",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-address-range",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-address-range": {
      "description": "",
      "request": "POST {{server}}/set-address-range\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Address Range 1\",\n  \"new-name\" : \"New Address Range 2\",\n  \"color\" : \"green\",\n  \"ip-address-first\" : \"192.0.2.1\",\n  \"ip-address-last\" : \"192.0.2.1\",\n  \"groups\" : \"New Group 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.946644",
    "source_file": "set-address-range.html"
  }
}
```