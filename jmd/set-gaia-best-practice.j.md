...
```json
{
  "command": "set-gaia-best-practice",
  "description": "Modify a user-defined Gaia Best Practice.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-gaia-best-practice",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-gaia-best-practice": {
      "description": "Modify a Gaia Best Practice created by the user (user-defined)",
      "request": "POST {{server}}/set-gaia-best-practice\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"uid\" : \"af439463-8370-416b-8bab-55e702a37274\",\n  \"description\" : \"This is a new description for the Best Practice.\",\n  \"new-name\" : \"Edited Best Practice\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:16.754012",
    "source_file": "set-gaia-best-practice.html"
  }
}
```