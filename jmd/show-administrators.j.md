...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-administrators",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-administrators": {
      "description": "",
      "request": "POST {{server}}/show-administrators\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.809167",
    "source_file": "show-administrators.html"
  }
}
```