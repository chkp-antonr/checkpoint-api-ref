...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-repository-package",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "path",
        "description": "The path of the repository package.Required only for adding package from local.",
        "type": "string",
        "required": true
      },
      {
  ...
  "examples": {
    "add-repository-package": {
      "description": "",
      "request": "POST {{server}}/add-repository-package\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"source\" : \"local\",\n  \"name\" : \"Check_Point_R80_20_JUMBO_HF_Bundle_T118_sk137592_Security_Gateway_and_Standalone_2_6_18_FULL.tgz\",\n  \"path\" : \"/home/admin/\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.362368",
    "source_file": "add-repository-package.html"
  }
}
```