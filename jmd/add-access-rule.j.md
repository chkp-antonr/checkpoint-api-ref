...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-access-rule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-access-rule": {
      "description": "",
      "request": "POST {{server}}/add-access-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"layer\" : \"Network\",\n  \"position\" : 1,\n  \"name\" : \"Rule 1\",\n  \"service\" : [ \"SMTP\", \"AOL\" ],\n  \"vpn\" : \"MyIntranet\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.431979",
    "source_file": "add-access-rule.html"
  }
}
```