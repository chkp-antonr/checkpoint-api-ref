...
```json
{
  "command": "show-administrator",
  "description": "Retrieve existing administrator using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-administrator",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-administrator": {
      "description": "",
      "request": "POST {{server}}/show-administrator\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"admin\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.789420",
    "source_file": "show-administrator.html"
  }
}
```