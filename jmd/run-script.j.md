...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/run-script",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      {
        "name": "uid",
        "description": "Repository script unique identifier.Can be used for script-type \"repository\".",
        "type": "string",
        "required": true
      },
      {
      ...
      {
        "name": "script-base64",
        "description": "The entire content of the script encoded in Base64.Required only for script-type \"one time\".",
        "type": "string",
        "required": false
      },
      {
  ...
  "examples": {
    "run-script": {
      "description": "",
      "request": "POST {{server}}/run-script\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"script-name\" : \"Script Example: List files under / dir\",\n  \"script\" : \"ls -l /\",\n  \"targets\" : [ \"corporate-gateway\" ]\n}",
      "response": ""
    },
    "run-script encoded in base64": {
      "description": "",
      "request": "POST {{server}}/run-script\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"script-name\" : \"Script Example: List files under / dir\",\n  \"script-base64\" : \"bHMgLWwgLw==\",\n  \"targets\" : [ \"corporate-gateway\" ]\n}",
      "response": ""
    },
    "run-script from repository": {
      "description": "",
      "request": "POST {{server}}/run-script\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"script-name\" : \"Name of Repository Script\",\n  \"script-type\" : \"repository\",\n  \"targets\" : [ \"corporate-gateway\" ]\n}",
      "response": ""
    },
    "run-script one time": {
      "description": "",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.673455",
    "source_file": "run-script.html"
  }
}
```