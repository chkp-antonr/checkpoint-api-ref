...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-policy-settings",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-policy-settings": {
      "description": "Show Policy settings",
      "request": "POST {{server}}/show-policy-settings\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": "{\n  \"security-access-defaults\" : {\n    \"source\" : \"any\",\n    \"destination\" : \"any\",\n    \"service\" : \"any\"\n  },\n  \"last-in-cell\" : \"restore to default\",\n  \"none-object-behavior\" : \"none\"\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.815628",
    "source_file": "show-policy-settings.html"
  }
}
```