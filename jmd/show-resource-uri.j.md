...
```json
{
  "command": "show-resource-uri",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-resource-uri",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-resource-uri": {
      "description": "",
      "request": "POST {{server}}/show-resource-uri\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newUriResource\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.125647",
    "source_file": "show-resource-uri.html"
  }
}
```