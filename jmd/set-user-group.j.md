...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-user-group",
    "headers": [
      {
        "name": "Content-Type",
