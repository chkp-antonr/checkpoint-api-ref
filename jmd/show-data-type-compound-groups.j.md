...
```json
{
  "command": "show-data-type-compound-groups",
  "description": "Retrieve all Compound Data Type Group objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-type-compound-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-type-compound-groups": {
      "description": "",
      "request": "POST {{server}}/show-data-type-compound-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.738525",
    "source_file": "show-data-type-compound-groups.html"
  }
}
```