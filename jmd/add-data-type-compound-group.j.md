...
```json
{
  "command": "add-data-type-compound-group",
  "description": "Create new Compound Data Type Group Object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-data-type-compound-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.781420",
    "source_file": "add-data-type-compound-group.html"
  }
}
```