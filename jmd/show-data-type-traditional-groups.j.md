...
```json
{
  "command": "show-data-type-traditional-groups",
  "description": "Retrieve all Traditional Group Data Type objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-type-traditional-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-type-traditional-groups": {
      "description": "",
      "request": "POST {{server}}/show-data-type-traditional-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.922644",
    "source_file": "show-data-type-traditional-groups.html"
  }
}
```