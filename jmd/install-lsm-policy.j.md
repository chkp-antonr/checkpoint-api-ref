...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/install-lsm-policy",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "Install LSM Policy": {
      "description": "",
      "request": "POST {{server}}/install-lsm-policy\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"targets\" : [ \"lsm_gateway\" ]\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.489114",
    "source_file": "install-lsm-policy.html"
  }
}
```