...
```json
{
  "command": "show-cluster-member",
  "description": "Retrieve existing cluster member using uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-cluster-member",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-cluster-member": {
      "description": "",
      "request": "POST {{server}}/show-cluster-member\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"uid\" : \"871a47b9-0000-4444-555-593c2111111\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.402654",
    "source_file": "show-cluster-member.html"
  }
}
```