...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-global-domain",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-global-domain": {
      "description": "",
      "request": "POST {{server}}/show-global-domain\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Global2\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.655224",
    "source_file": "show-global-domain.html"
  }
}
```