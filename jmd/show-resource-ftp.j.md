...
```json
{
  "command": "show-resource-ftp",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-resource-ftp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-resource-ftp": {
      "description": "",
      "request": "POST {{server}}/add-resource-ftp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newFtpResource\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.009233",
    "source_file": "show-resource-ftp.html"
  }
}
```