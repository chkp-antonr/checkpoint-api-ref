...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-nat-rule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-nat-rule": {
      "description": "",
      "request": "POST {{server}}/add-nat-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"package\" : \"standard\",\n  \"position\" : \"top\",\n  \"comments\" : \"comment example1 nat999\",\n  \"enabled\" : false,\n  \"install-on\" : [ \"Policy Targets\" ],\n  \"original-source\" : \"Any\",\n  \"original-destination\" : \"All_Internet\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.036170",
    "source_file": "add-nat-rule.html"
  }
}
```