...
```json
{
  "command": "set-radius-server",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-radius-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set radius-server": {
      "description": "Set Radius server name",
      "request": "POST {{server}}/set-radius-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"t4\",\n  \"server\" : \"hostRadius\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.822303",
    "source_file": "set-radius-server.html"
  }
}
```