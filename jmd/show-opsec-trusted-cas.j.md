...
```json
{
  "command": "show-opsec-trusted-cas",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-opsec-trusted-cas",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show opsec-trusted-cas": {
      "description": "Show opsec trusted cas",
      "request": "POST {{server}}/show-opsec-trusted-cas\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.613640",
    "source_file": "show-opsec-trusted-cas.html"
  }
}
```