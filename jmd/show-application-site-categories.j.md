...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-application-site-categories",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-application-site-categories": {
      "description": "",
      "request": "POST {{server}}/show-application-site-categories\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.943190",
    "source_file": "show-application-site-categories.html"
  }
}
```