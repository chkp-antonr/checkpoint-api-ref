...
```json
{
  ...
  "description": "Retrieve domain high availability state.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-ha-state",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-ha-state": {
      "description": "",
      "request": "POST {{server}}/show-ha-state\nContent-type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.968598",
    "source_file": "show-ha-state.html"
  }
}
```