...
```json
{
  "command": "set-application-site-group",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-application-site-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-application-site-group": {
      "description": "",
      "request": "POST {{server}}/set-application-site-group\nContent-Type: application/json\nSes: \nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Application Site Group 1\",\n  \"members\" : {\n    \"add\" : \"AliveProxy\"\n  },\n  \"groups\" : \"New Application Site Group 2\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:16.107217",
    "source_file": "set-application-site-group.html"
  }
}
```