...
```json
{
  "command": "set-resource-mms",
  "description": "Edit existing MMS resource using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-resource-mms",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-resource-mms": {
      "description": "",
      "request": "POST {{server}}/set-resource-mms\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newMmsResource\",\n  \"action\" : \"drop\",\n  \"track\" : \"popup alert\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.910407",
    "source_file": "set-resource-mms.html"
  }
}
```