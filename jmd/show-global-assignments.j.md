...
```json
{
  "command": "show-global-assignments",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-global-assignments",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-global-assignments": {
      "description": "",
      "request": "POST {{server}}/show-global-assignments\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.608041",
    "source_file": "show-global-assignments.html"
  }
}
```