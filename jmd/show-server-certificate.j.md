...
```json
{
  "command": "show-server-certificate",
  "description": "Show existing server certificate using name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-server-certificate",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-server-certificate": {
      "description": "Show a server certificate object.",
      "request": "POST {{server}}/show-server-certificate\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"MyServerCertificate\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.331784",
    "source_file": "show-server-certificate.html"
  }
}
```