...
```json
{
  ...
  "description": "Retrieve all network interfaces for specified gateway or cluster.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-interfaces",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "response": {
    "success": [
      ...
      {
        "name": "member-uid",
        "description": "Cluster member uid.",
        "type": "string",
        "required": false
      },
      {
  ...
  "examples": {
    "show gateway network interfaces": {
      "description": "Show all network interfaces of a gateway.",
      "request": "POST {{server}}/show-interfaces\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"gateway-uid\" : \"ff918e85-98c4-4b17-bcac-417aab863d87\",\n  \"details-level\" : \"full\",\n  \"offset\" : 0,\n  \"limit\" : 50\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.537036",
    "source_file": "show-interfaces.html"
  }
}
```