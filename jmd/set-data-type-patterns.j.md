...
```json
{
  "command": "set-data-type-patterns",
  "description": "Edit existing Pattern Data Type object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-data-type-patterns",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-data-type-patterns": {
      "description": "",
      "request": "POST {{server}}/set-data-type-patterns\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"pattern-obj\",\n  \"patterns.remove.1\" : \"^d\",\n  \"number-of-occurrences\" : 3\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:16.495087",
    "source_file": "set-data-type-patterns.html"
  }
}
```