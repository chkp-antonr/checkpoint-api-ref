...
```json
{
  "command": "show-exception-groups",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-exception-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-exception-groups": {
      "description": "",
      "request": "POST {{server}}/show-exception-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.318673",
    "source_file": "show-exception-groups.html"
  }
}
```