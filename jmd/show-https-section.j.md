...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-https-section",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-https-section": {
      "description": "",
      "request": "POST {{server}}/show-https-section\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"layer\" : \"Default Layer\",\n  \"name\" : \"New Section 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.205877",
    "source_file": "show-https-section.html"
  }
}
```