...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-service-icmp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-service-icmp": {
      "description": "",
      "request": "POST {{server}}/show-service-icmp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"info-req\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.507951",
    "source_file": "show-service-icmp.html"
  }
}
```