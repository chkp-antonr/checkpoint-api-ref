...
```json
{
  "command": "add-gsn-handover-group",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-gsn-handover-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.237528",
    "source_file": "add-gsn-handover-group.html"
  }
}
```