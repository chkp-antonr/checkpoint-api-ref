...
```json
{
  "command": "clone-service-icmp6",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-service-icmp6",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "icmp-code",
        "description": "As listed in: RFC 792.",
        "type": "integer",
        "required": false
      },
      {
  ...
  "examples": {
    "clone-service-icmp6": {
      "description": "",
      "request": "POST {{server}}/clone-service-icmp6\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"icmp1\",\n  \"new-name\" : \"icmp2\",\n  \"icmp-type\" : 45,\n  \"icmp-code\" : 13\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.527388",
    "source_file": "clone-service-icmp6.html"
  }
}
```