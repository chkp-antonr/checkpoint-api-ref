...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-tacacs-server",
    "headers": [
      {
        "name": "Content-Type",
