...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/delete-domain",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "delete-domain": {
      "description": "",
      "request": "POST {{server}}/delete-domain\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"domain1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:14.405765",
    "source_file": "delete-domain.html"
  }
}
```