...
```json
{
  "command": "clone-application-site",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-application-site",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.375733",
    "source_file": "clone-application-site.html"
  }
}
```