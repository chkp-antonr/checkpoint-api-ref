...
```json
{
  "command": "clone-gsn-handover-group",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-gsn-handover-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.534123",
    "source_file": "clone-gsn-handover-group.html"
  }
}
```