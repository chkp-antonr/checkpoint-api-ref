...
```json
{
  "command": "clone-dynamic-object",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-dynamic-object",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-dynamic-object": {
      "description": "Clone existing dynamic object",
      "request": "POST {{server}}/clone-dynamic-object\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Dynamic_Object_1\",\n  \"new-name\" : \"Dynamic_Object_2\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.425037",
    "source_file": "clone-dynamic-object.html"
  }
}
```