# show-app-control-advanced-settings
...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-app-control-advanced-settings",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-app-control-advanced-settings": {
      "description": "",
      "request": "POST {{server}}/show-app-control-advanced-settings\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.884864",
    "source_file": "show-app-control-advanced-settings.html"
  }
}
```