...
```json
{
  "command": "set-service-icmp",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-service-icmp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-service-icmp": {
      "description": "",
      "request": "POST {{server}}/set-service-icmp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"icmp1\",\n  \"new-name\" : \"icmp2\",\n  \"icmp-type\" : 45,\n  \"icmp-code\" : 13\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:19.306527",
    "source_file": "set-service-icmp.html"
  }
}
```