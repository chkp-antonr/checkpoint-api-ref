# show-data-types-file-attributes

```json
{
  "command": "show-data-types-file-attributes",
  "description": "Retrieve all File Attributes Data Type objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-types-file-attributes",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-types-file-attributes": {
      "description": "",
      "request": "POST {{server}}/show-data-types-file-attributes\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 5\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.960697",
    "source_file": "show-data-types-file-attributes.html"
  }
}
```