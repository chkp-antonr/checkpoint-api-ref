...
```json
{
  "command": "set-passcode-profile",
  "description": "Edit existing Passcode Profile using name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-passcode-profile",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.756619",
    "source_file": "set-passcode-profile.html"
  }
}
```