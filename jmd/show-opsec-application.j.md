...
```json
{
  "command": "show-opsec-application",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-opsec-application",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-opsec-application": {
      ...
      "request": "POST {{server}}/show-opsec-application\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"MyUpdatedOpsecApplication\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.571542",
    "source_file": "show-opsec-application.html"
  }
}
```