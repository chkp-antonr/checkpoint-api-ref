# show-passcode-profiles

```json
{
  "command": "show-passcode-profiles",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-passcode-profiles",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-passcode-profiles": {
      "description": "Showing a list of Passcode profiles",
      "request": "POST {{server}}/show-passcode-profiles\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.788743",
    "source_file": "show-passcode-profiles.html"
  }
}
```