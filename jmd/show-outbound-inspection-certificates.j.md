...
```json
{
  "command": "show-outbound-inspection-certificates",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-outbound-inspection-certificates",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-outbound-inspection-certificates": {
      "description": "Show all outbound certificates objects.",
      "request": "POST {{server}}/show-outbound-inspection-certificates\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.646723",
    "source_file": "show-outbound-inspection-certificates.html"
  }
}
```