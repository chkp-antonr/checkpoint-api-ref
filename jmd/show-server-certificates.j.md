...
```json
{
  "command": "show-server-certificates",
  "description": "Show existing server certificates.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-server-certificates",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-server-certificates": {
      "description": "Show all server certificates objects.",
      "request": "POST {{server}}/show-server-certificates\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": "{\n  \"from\" : 1,\n  \"to\" : 1,\n  \"total\" : 1,\n  \"objects\" : [ {\n    \"uid\" : \"85944ed6-fa09-40c9-ada9-d980a1dc3f3c\",\n    \"name\" : \"MyServerCertificate\",\n    \"type\" : \"server-certificate\",\n    \"domain\" : {\n      \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\",\n      \"name\" : \"SMC User\",\n      \"domain-type\" : \"domain\"\n    },\n    \"icon\" : \"subject_user_certificate\",\n    \"color\" : \"black\"\n  } ]\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.345245",
    "source_file": "show-server-certificates.html"
  }
}
```