...
```json
{
  "command": "clone-service-gtp",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-service-gtp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-service-gtp": {
      "description": "Clone an existing GTP service",
      "request": "POST {{server}}/clone-service-gtp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New_gtp_Service_3\",\n  \"new-name\" : \"New_gtp_Service_4\",\n  \"version\" : \"V1\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.477569",
    "source_file": "clone-service-gtp.html"
  }
}
```