...
```json
{
  "command": "set-access-role",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-access-role",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-access-role": {
      "description": "",
      "request": "POST {{server}}/set-access-role\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Access Role 1\",\n  \"users\" : \"all identified\",\n  \"machines\" : \"any\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.783285",
    "source_file": "set-access-role.html"
  }
}
```