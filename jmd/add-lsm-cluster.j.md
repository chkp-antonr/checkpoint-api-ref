...
```json
{
  "command": "add-lsm-cluster",
  "description": "Add LSM Cluster.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-lsm-cluster",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.683800",
    "source_file": "add-lsm-cluster.html"
  }
}
```