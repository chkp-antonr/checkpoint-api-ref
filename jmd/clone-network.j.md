...
```json
{
  "command": "clone-network",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-network",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-network": {
      "description": "",
      "request": "POST {{server}}/clone-network\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Network 1\",\n  \"new-name\" : \"New Network 2\",\n  \"color\" : \"green\",\n  \"subnet\" : \"192.0.0.0\",\n  \"mask-length\" : 16,\n  \"groups\" : \"New Group 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.952707",
    "source_file": "clone-network.html"
  }
}
```