...
```json
{
  "command": "clone-network-probe",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-network-probe",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "destination",
        "description": "One of these:- Name or UID of an existing object with a unicast IPv4 address (Host, Security Gateway, and so on).- A unicast IPv4 address string (if you do not want to create such an object).",
        "type": "string",
        "required": false
      },
      {
        "name": "source",
        "description": "One of these:- The string \"main-ip\" (the probe uses the main IPv4 address of the Security Gateway objects you specified in the parameter [install-on]).- Name or UID of an existing object of type 'Host' with a unicast IPv4 address.- A unicast IPv4 address string (if you do not want to create such an object).",
        "type": "string",
        "required": false
      },
      {
      ...
      {
        "name": "interval",
        "description": "The time interval (in seconds) between each probe request.Best Practice - The interval value should be lower than the timeout value.",
        "type": "integer",
        "required": false,
        "valid_values": [
          "5-300"
  ...
  "examples": {
    "clone-network-probe": {
      "description": "Clone existing Network Probe.",
      "request": "POST {{server}}/clone-network-probe\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"probe_GW1\",\n  \"new-name\" : \"probe_GW1_http\",\n  \"protocol\" : \"http\",\n  \"http-options\" : {\n    \"destination\" : \"https://www.google.com\"\n  }\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.923121",
    "source_file": "clone-network-probe.html"
  }
}
```