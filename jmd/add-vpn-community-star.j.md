...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-vpn-community-star",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      },
      {
        ...
        "type": "string",
        "required": false,
        "default": "both center and satellite gateways",
        "valid_values": [
      ...
      },
      {
        ...
        "description": "Collection of services that are excluded from the community identified by the name or UID. Connections with these services will not be encrypted and will not match rules specifying the community in the VPN community.",
        "type": "string",
        "required": false
      },
      {
      ...
      },
      {
        ...
        "type": "string",
        "required": false,
        "default": "closest gateway to source",
        "valid_values": [
          "closest gateway to source",
          "closest gateway to destination",
          "random selection",
  ...
  "examples": {
    ...
    "add-vpn-community-star (Default Enhanced Link Selection Interfaces)": {
      "description": "Adds a new VPN Star Community with default Enhanced Link Selection Interfaces configuration",
    ...
    "add-vpn-community-star (with override vpn domain)": {
      "description": "Adds a new VPN Star Community with Override VPN Domain",
    ...
    "add-vpn-community-star (with shared secrets)": {
      "description": "Adds a new VPN Star Community with Shared Secrets",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:10.508104",
    "source_file": "add-vpn-community-star.html"
  }
}
```