...
```json
{
  "command": "show-https-rule",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-https-rule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-https-rule": {
      "description": "",
      "request": "POST {{server}}/show-https-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"layer\" : \"Default Layer\",\n  \"rule-number\" : 1\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.173468",
    "source_file": "show-https-rule.html"
  }
}
```