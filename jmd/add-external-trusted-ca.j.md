# add-external-trusted-ca

```json
{
  "command": "add-external-trusted-ca",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-external-trusted-ca",
    "headers": [
      {
        "name": "Content-Type",
