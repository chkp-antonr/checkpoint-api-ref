...
```json
{
  "command": "clone-gaia-best-practice",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-gaia-best-practice",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.440851",
    "source_file": "clone-gaia-best-practice.html"
  }
}
```