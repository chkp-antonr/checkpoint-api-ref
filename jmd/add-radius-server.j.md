...
```json
{
  "command": "add-radius-server",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-radius-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add radius-server": {
      ...
      "request": "POST {{server}}/add-radius-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"radServer\",\n  \"server\" : \"hostRad\",\n  \"shared-secret\" : \"123\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.354020",
    "source_file": "add-radius-server.html"
  }
}
```