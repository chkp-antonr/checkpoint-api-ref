...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-time-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-time-groups": {
      "description": "",
      "request": "POST {{server}}/show-time-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.055878",
    "source_file": "show-time-groups.html"
  }
}
```