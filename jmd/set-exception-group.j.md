...
```json
{
  "command": "set-exception-group",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-exception-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-exception-group": {
      ...
      "request": "POST {{server}}/set-exception-group\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"exception_group_2\",\n  \"new-name\" : \"exception_group_2.1\",\n  \"tags\" : \"tag3\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:16.718398",
    "source_file": "set-exception-group.html"
  }
}
```