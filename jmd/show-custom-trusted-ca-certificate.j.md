...
```json
{
  "command": "show-custom-trusted-ca-certificate",
  "description": "Retrieve existing custom trusted CA certificate using name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-custom-trusted-ca-certificate",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-custom-trusted-ca-certificate": {
      "description": "",
      "request": "POST {{server}}/show-custom-trusted-ca-certificate\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"uid\" : \"f6afaa0f-f978-4b1c-8575-6cbc9459af11\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.510634",
    "source_file": "show-custom-trusted-ca-certificate.html"
  }
}
```