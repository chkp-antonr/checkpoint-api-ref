...
```json
{
  "command": "show-data-type-file-groups",
  "description": "Retrieve all File Group objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-type-file-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-type-file-groups": {
      "description": "",
      "request": "POST {{server}}/show-data-type-file-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.798767",
    "source_file": "show-data-type-file-groups.html"
  }
}
```