# add-gaia-best-practice

```json
{
  "command": "add-gaia-best-practice",
  "description": "Add a new Gaia Best Practice with a custom script that runs on Gaia Security Gateways. During the Compliance scan, the practice script runs on the Gaia Security Gateway. To comply with the Best Practice, the script's output should match the expected output parameter.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-gaia-best-practice",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "response": {
    "success": [
      {
        "name": "name",
        "description": "The Best Practice name.",
        "type": "string",
        "required": false
      },
      {
      ...
      {
        "name": "type",
        "description": "The type of Best Practice.",
        "type": "string",
        "required": false
      },
      {
  ...
  "examples": {
    ...
    "add-gaia-best-practice to make sure that the NTP service is active in the Security Gateway.": {
      "description": "Add a new Gaia Best Practice (using a script in Base64) to make sure that the NTP service is active in the Security Gateway.",
    ...
    "add-gaia-best-practice with path": {
      "description": "Add a new Gaia Best Practice using an absolute path to a script file on the Management",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.129701",
    "source_file": "add-gaia-best-practice.html"
  }
}
```