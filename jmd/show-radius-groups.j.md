...
```json
{
  "command": "show-radius-groups",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-radius-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-radius-groups": {
      "description": "Show Radius groups",
      "request": "POST {{server}}/show-radius-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 4,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.887532",
    "source_file": "show-radius-groups.html"
  }
}
```