...
```json
{
  "command": "add-https-rule",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-https-rule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-https-rule": {
      "description": "",
      "request": "POST {{server}}/add-https-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"layer\" : \"Default Layer\",\n  \"position\" : 1,\n  \"name\" : \"FirstRule\"\n}",
      "response": ""
    },
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.353823",
    "source_file": "add-https-rule.html"
  }
}
```