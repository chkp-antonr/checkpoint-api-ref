...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-user",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      },
      {
        ...
        "description": "Days which users must to enroll.",
        "type": "integer",
        "required": false,
        "default": "14"
      },
  ...
  "examples": {
    "clone-user": {
      "description": "",
      "request": "POST {{server}}/clone-user\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"myuser\",\n  \"authentication-method\" : \"undefined\",\n  \"expiration-date\" : \"2035-01-15\",\n  \"from-hour\" : \"12:00\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:14.098000",
    "source_file": "clone-user.html"
  }
}
```