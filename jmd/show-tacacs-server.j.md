...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-tacacs-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show tacacs-server": {
      "description": "Show tacacs server",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.614548",
    "source_file": "show-tacacs-server.html"
  }
}
```