...
```json
{
  "command": "show-lsm-cluster-profile",
  "description": "Show LSM Gateway Profile.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-lsm-cluster-profile",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "response": {
    "success": [
      ...
      {
        "name": "do-not-check-specific-packets",
        "description": "N/A",
        "type": "boolean",
        "required": false
      },
      {
        "name": "do-not-check-specific-packets-from",
        "description": "N/A",
        "type": "string",
        "required": false
      },
      ...
      {
        "name": "ip-addresses-behind-this-interface",
        "description": "N/A",
        "type": "string",
        "required": false,
        "valid_values": [
  ...
  "examples": {
    "show-lsm-cluster-profile": {
      "description": "",
      "request": "POST {{server}}/show-lsm-cluster-profile\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"cluster_profile\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.853405",
    "source_file": "show-lsm-cluster-profile.html"
  }
}
```