...
```json
{
  "command": "show-access-point-name",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-access-point-name",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-access-point-name": {
      "description": "",
      "request": "POST {{server}}/show-access-point-name\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"myaccesspointname\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.460699",
    "source_file": "show-access-point-name.html"
  }
}
```