...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-time-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-time-group": {
      "description": "",
      "request": "POST {{server}}/show-time-group\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"timeGroup-1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.043408",
    "source_file": "show-time-group.html"
  }
}
```