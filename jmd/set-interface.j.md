...
```json
{
  ...
  "description": "Edit existing network interface using object uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-interface",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "uid",
        "description": "Cluster member network interface uid.",
        "type": "string",
        "required": true
      },
      {
        "name": "member-uid",
        "description": "Cluster member object uid. Required only if name was specified.",
        "type": "string",
        "required": false
      },
      {
  ...
  "examples": {
    "set cluster and sync interface": {
      "description": "Modify an existing cluster network interface, set interface as 'cluster + sync' with internal topology defined by routes.",
      "request": "POST {{server}}/set-interface\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"uid\" : \"dae6afba-0b11-49b8-911d-df084cba0bba\",\n  \"cluster-network-type\" : \"cluster + sync\",\n  \"ipv4-address\" : \"4.4.4.111\",\n  \"ipv4-mask-length\" : 22,\n  \"topology\" : \"internal\",\n  \"topology-settings\" : {\n    \"ip-address-behind-this-interface\" : \"network defined by routing\"\n  },\n  \"cluster-members\" : [ {\n    \"uid\" : \"db4f8a63-5a94-46d8-b9e0-a63870bded3d\",\n    \"ipv4-address\" : \"4.4.4.1\",\n    \"ipv4-mask-length\" : 22\n  }, {\n    \"uid\" : \"baca571e-8ada-4be9-8966-145388f8e238\",\n    \"ipv4-address\" : \"4.4.4.2\",\n    \"ipv4-mask-length\" : 22\n  } ]\n}",
      "response": ""
    },
    "set cluster interface": {
      "description": "Modify an existing cluster network interface, set internal topology as network defined by the interface ip and net mask and enable anti-spoofing.",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:17.693411",
    "source_file": "set-interface.html"
  }
}
```