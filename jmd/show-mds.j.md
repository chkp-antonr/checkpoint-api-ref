...
{
  "command": "show-mds",
  "description": "Retrieve existing object of type Multi-Domain Server or Multi-Domain Log Server using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-mds",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-mds": {
      "description": "",
      "request": "POST {{server}}/show-mds\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"test_mds1\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.096692",
    "source_file": "show-mds.html"
  }
}
```