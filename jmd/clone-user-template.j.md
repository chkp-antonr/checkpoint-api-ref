...
```json
{
  "command": "clone-user-template",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-user-template",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "expiration-by-global-properties",
  ...
  "examples": {
    "clone-user-template": {
      "description": "",
      "request": "POST {{server}}/clone-user-template\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"myusertemplate\",\n  \"expiration-by-global-properties\" : \"True\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:14.040855",
    "source_file": "clone-user-template.html"
  }
}
```