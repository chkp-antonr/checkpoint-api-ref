...
```json
{
  "command": "add-service-icmp",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-service-icmp",
    "headers": [
      {
        "name": "Content-Type",
