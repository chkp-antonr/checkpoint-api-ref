...
```json
{
  "command": "set-application-site",
  "description": "Edit existing application using object name or uid. It's impossible to set 'application-signature' when the application was initialized with 'url-list' and vice-verse.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-application-site",
    "headers": [
      {
        "name": "Content-Type",
