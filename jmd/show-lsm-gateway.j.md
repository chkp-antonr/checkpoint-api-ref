...
```json
{
  "command": "show-lsm-gateway",
  "description": "Show LSM Gateway.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-lsm-gateway",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-lsm-gateway": {
      "description": "",
      "request": "POST {{server}}/show-lsm-gateway\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"lsm_gateway\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.981667",
    "source_file": "show-lsm-gateway.html"
  }
}
```