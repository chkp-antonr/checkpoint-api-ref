...
```json
{
  "command": "show-services-citrix-tcp",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-services-citrix-tcp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-services-citrix-tcp": {
      "description": "",
      "request": "POST {{server}}/show-services-citrix-tcp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 10\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.637792",
    "source_file": "show-services-citrix-tcp.html"
  }
}
```