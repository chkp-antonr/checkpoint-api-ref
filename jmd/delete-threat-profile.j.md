...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/delete-threat-profile",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "delete-threat-profile": {
      "description": "",
      "request": "POST {{server}}/delete-threat-profile\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Profile 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.226624",
    "source_file": "delete-threat-profile.html"
  }
}
```