...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-user-group",
    "headers": [
      {
        "name": "Content-Type",
