...
```json
{
  "command": "add-mobile-access-rule",
  "description": "Create new Mobile Access rule for associating groups of users with a available apps.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-mobile-access-rule",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "name",
        "description": "Mobile Access rule name.",
        "type": "string",
        "required": false
      },
      {
  ...
  "examples": {
    "add-mobile-access-rule": {
      "description": "",
      "request": "POST {{server}}/add-mobile-access-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"position\" : 1,\n  \"name\" : \"Rule 1\",\n  \"applications\" : \"New Application\",\n  \"user-groups\" : [ \"my_group\" ]\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.868211",
    "source_file": "add-mobile-access-rule.html"
  }
}
```