...
```json
{
  "command": "set-https-rule",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-https-rule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-https-rule": {
      "description": "",
      "request": "POST {{server}}/set-https-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"rule-number\" : 1,\n  \"layer\" : \"Default Layer\",\n  \"new-position\" : 2\n}",
      "response": ""
    },
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:17.493078",
    "source_file": "set-https-rule.html"
  }
}
```