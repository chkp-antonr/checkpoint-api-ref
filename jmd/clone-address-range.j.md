...
```json
{
  "command": "clone-address-range",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-address-range",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-address-range": {
      "description": "",
      "request": "POST {{server}}/clone-address-range\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Address Range 1\",\n  \"new-name\" : \"New Address Range 2\",\n  \"color\" : \"green\",\n  \"ip-address-first\" : \"192.0.2.1\",\n  \"ip-address-last\" : \"192.0.2.1\",\n  \"groups\" : \"New Group 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.305167",
    "source_file": "clone-address-range.html"
  }
}
```