...
```json
{
  "command": "add-resource-uri-for-qos",
  "description": "Create new Uri For QoS resource.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-resource-uri-for-qos",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.514365",
    "source_file": "add-resource-uri-for-qos.html"
  }
}
```