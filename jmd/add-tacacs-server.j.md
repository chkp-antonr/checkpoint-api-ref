...
```json
{
  "command": "add-tacacs-server",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-tacacs-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add tacacs-server": {
      ...
      "request": "POST {{server}}/add-tacacs-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"tacacs7\",\n  \"server\" : \"h1\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:09.622479",
    "source_file": "add-tacacs-server.html"
  }
}
```