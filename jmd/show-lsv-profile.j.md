...
```json
{
  "command": "show-lsv-profile",
  "description": "Retrieve existing LSV profile object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-lsv-profile",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show lsv-profile": {
      "description": "Show information of an LSV Profile",
      "request": "POST {{server}}/show-lsv-profile\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"existing lsv-profile\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.011022",
    "source_file": "show-lsv-profile.html"
  }
}
```