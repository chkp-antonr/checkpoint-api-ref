...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-ips-update-schedule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-ips-update-schedule-interval": {
      ...
      "request": "POST {{server}}/set-ips-update-schedule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"enabled\" : true,\n  \"recurrence\" : {\n    \"pattern\" : \"interval\",\n    \"minutes\" : 145\n  }\n}",
      "response": "{\n  \"enabled\" : true,\n  \"recurrence\" : {\n    \"pattern\" : \"Interval\",\n    \"minutes\" : 45\n  }\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:17.797169",
    "source_file": "set-ips-update-schedule.html"
  }
}
```