...
```json
{
  "command": "show-opsec-applications",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-opsec-applications",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-opsec-applications": {
      ...
      "request": "POST {{server}}/show-opsec-applications\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.583869",
    "source_file": "show-opsec-applications.html"
  }
}
```