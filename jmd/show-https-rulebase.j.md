...
```json
{
  ...
  "request": {
    ...
    "body": [
      ...
      },
      {
        ...
        "description": "Receiving the mapping between the objects id and the whole objects.",
        "type": "boolean",
        "required": false
      }
    ]
  ...
  "examples": {
    "show-https-rulebase": {
      "description": "",
      "request": "POST {{server}}/show-https-rulebase\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"offset\" : 0,\n  \"limit\" : 20,\n  \"name\" : \"Default Layer\",\n  \"details-level\" : \"standard\",\n  \"use-object-dictionary\" : false\n}",
      "response": ""
    },
    "show-https-rulebase-with-filter": {
      "description": "",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.192840",
    "source_file": "show-https-rulebase.html"
  }
}
```