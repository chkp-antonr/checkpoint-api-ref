...
```json
{
  "command": "add-data-type-weighted-keywords",
  "description": "Create new Weighted Keywords Data Type Object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-data-type-weighted-keywords",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.893403",
    "source_file": "add-data-type-weighted-keywords.html"
  }
}
```