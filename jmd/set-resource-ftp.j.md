...
```json
{
  "command": "set-resource-ftp",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-resource-ftp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-resource-ftp": {
      "description": "",
      "request": "POST {{server}}/set-resource-ftp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newFtpResource\",\n  \"resource-matching-method\" : \"put\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.893337",
    "source_file": "set-resource-ftp.html"
  }
}
```