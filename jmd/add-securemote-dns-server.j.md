...
```json
{
  "command": "add-securemote-dns-server",
  "description": "Create new SecuRemote DNS server.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-securemote-dns-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.598739",
    "source_file": "add-securemote-dns-server.html"
  }
}
```