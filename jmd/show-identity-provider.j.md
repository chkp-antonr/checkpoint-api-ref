...
```json
{
  "command": "show-identity-provider",
  "description": "Retrieve existing SAML Identity Provider using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-identity-provider",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show identity-provider": {
      "description": "Retrieve existing identity-provider.",
      "request": "POST {{server}}/show-identity-provider\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"TestIdp\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.227456",
    "source_file": "show-identity-provider.html"
  }
}
```