...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-access-layers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-access-layers": {
      "description": "",
      "request": "POST {{server}}/show-access-layers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.429274",
    "source_file": "show-access-layers.html"
  }
}
```