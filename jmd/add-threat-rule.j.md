...
```json
{
  "command": "add-threat-rule",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-threat-rule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:09.855147",
    "source_file": "add-threat-rule.html"
  }
}
```