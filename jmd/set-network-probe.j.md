...
```json
{
  "command": "set-network-probe",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-network-probe",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-network-probe": {
      "description": "Modifies an existing Network Probe.",
      "request": "POST {{server}}/set-network-probe\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"probe_GW1\",\n  \"icmp-options\" : {\n    \"source\" : \"1.1.1.1\",\n    \"destination\" : \"2.2.2.2\"\n  }\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.549718",
    "source_file": "set-network-probe.html"
  }
}
```