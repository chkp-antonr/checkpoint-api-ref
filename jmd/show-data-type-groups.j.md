# show-data-type-groups

```json
{
  "command": "show-data-type-groups",
  "description": "Retrieve all Data Group Type objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-type-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show data-types-keywords": {
      "description": "",
      "request": "POST {{server}}/show data-types-keywords\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.841252",
    "source_file": "show-data-type-groups.html"
  }
}
```