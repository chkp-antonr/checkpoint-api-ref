...
```json
{
  "command": "show-mobile-profile",
  "description": "Retrieve existing Mobile Profile using name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-mobile-profile",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-mobile-profile": {
      "description": "",
      "request": "POST {{server}}/show-mobile-profile\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Mobile Profile\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.242424",
    "source_file": "show-mobile-profile.html"
  }
}
```