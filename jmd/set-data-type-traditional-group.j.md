...
```json
{
  "command": "set-data-type-traditional-group",
  "description": "Edit existing Traditional Group Data Type using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-data-type-traditional-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-data-type-traditional-group": {
      "description": "",
      "request": "POST {{server}}/set-data-type-traditional-group\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"trad-group-obj\",\n  \"data-types.1\" : \"keywords_obj\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:16.513248",
    "source_file": "set-data-type-traditional-group.html"
  }
}
```