...
```json
{
  "command": "show-custom-trusted-ca-certificates",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-custom-trusted-ca-certificates",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-custom-trusted-ca-certificates": {
      "description": "",
      "request": "POST {{server}}/show-custom-trusted-ca-certificates\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.523289",
    "source_file": "show-custom-trusted-ca-certificates.html"
  }
}
```