...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-network",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-network": {
      "description": "",
      "request": "POST {{server}}/show-network\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Network 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.500669",
    "source_file": "show-network.html"
  }
}
```