...
```json
{
  "command": "show-network-probe",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-network-probe",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-network-probe": {
      "description": "Displays a Network Probe.",
      "request": "POST {{server}}/show-network-probe\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"probe_GW1\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.467036",
    "source_file": "show-network-probe.html"
  }
}
```