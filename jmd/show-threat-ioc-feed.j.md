...
```json
{
  "command": "show-threat-ioc-feed",
  "description": "Displays a threat IOC feed.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-threat-ioc-feed",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-threat-ioc-feed": {
      "description": "Showing a threat IOC feed",
      "request": "POST {{server}}/show-threat-ioc-feed\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"ioc_feed\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.825700",
    "source_file": "show-threat-ioc-feed.html"
  }
}
```