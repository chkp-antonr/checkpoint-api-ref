...
```json
{
  "command": "add-application-site",
  "description": "Creates new application site, which can be initialized with 'url-list' or 'application-signature' (not both of them).",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-application-site",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "urls-defined-as-regular-expression",
  ...
  "response": {
    "success": [
      ...
      {
        "name": "additional-categories-ids",
      ...
      },
      {
        ...
        "description": "Application signature generated by Signature Tool.",
        "type": "string",
        "required": false
      },
      {
  ...
  "examples": {
    "add-application-site": {
      "description": "",
      "request": "POST {{server}}/add-application-site\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Application Site 1\",\n  \"primary-category\" : \"Social Networking\",\n  \"description\" : \"My Application Site\",\n  \"additional-categories\" : [ \"Instant Chat\", \"Supports Streaming\", \"New Application Site Category 1\" ],\n  \"url-list\" : [ \"www.cnet.com\", \"www.stackoverflow.com\" ],\n  \"urls-defined-as-regular-expression\" : false\n}",
      "response": ""
    },
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.579423",
    "source_file": "add-application-site.html"
  }
}
```