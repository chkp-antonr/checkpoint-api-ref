...
```json
{
  "command": "show-multiple-key-exchanges-objects",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-multiple-key-exchanges-objects",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-multiple-key-exchanges-objects": {
      "description": "Show all Multiple Key Exchanges.",
      "request": "POST {{server}}/show-multiple-key-exchanges-objects\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": "{\n  \"from\" : 1,\n  \"to\" : 1,\n  \"total\" : 1,\n  \"objects\" : [ {\n    \"uid\" : \"5c25c4c4-4fc5-4371-b0f5-ab2473c6a69b\",\n    \"name\" : \"Multiple Key Exchanges\",\n    \"type\" : \"multiple-key-exchanges\",\n    \"domain\" : {\n      \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\",\n      \"name\" : \"SMC User\",\n      \"domain-type\" : \"domain\"\n    },\n    \"icon\" : \"General/globalsNa\",\n    \"color\" : \"black\"\n  } ]\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.306275",
    "source_file": "show-multiple-key-exchanges-objects.html"
  }
}
```