...
```json
{
  "command": "show-infinity-idp-objects",
  "description": "Retrieve all users/groups/machines from the Identity Provider.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-infinity-idp-objects",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.457954",
    "source_file": "show-infinity-idp-objects.html"
  }
}
```