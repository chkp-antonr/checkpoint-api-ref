...
```json
{
  "command": "show-log-exporters",
  "description": "Retrieve all log exporters.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-log-exporters",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show log-exporters": {
      "description": "Retrieve all log exporters.",
      "request": "POST {{server}}/show-log-exporters\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 5,\n  \"offset\" : 0,\n  \"details-level\" : \"full\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.793261",
    "source_file": "show-log-exporters.html"
  }
}
```