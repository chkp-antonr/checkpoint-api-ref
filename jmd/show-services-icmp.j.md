...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-services-icmp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-services-icmp": {
      "description": "",
      "request": "POST {{server}}/show-services-icmp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 4,\n  \"offset\" : 3\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.695237",
    "source_file": "show-services-icmp.html"
  }
}
```