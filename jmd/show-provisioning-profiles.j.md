...
```json
{
  "command": "show-provisioning-profiles",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-provisioning-profiles",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-provisioning-profiles": {
      "description": "",
      "request": "POST {{server}}/show-provisioning-profiles\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.855291",
    "source_file": "show-provisioning-profiles.html"
  }
}
```