...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-service-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-service-group": {
      "description": "",
      "request": "POST {{server}}/set-service-group\nContent-Type: application/json\nSes: \nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Service Group 1\",\n  \"members\" : {\n    \"add\" : \"http\"\n  }\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:19.232837",
    "source_file": "set-service-group.html"
  }
}
```