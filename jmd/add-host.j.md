...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-host",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    ...
    "add-host with group": {
      "description": "Adds simple host with group",
    ...
    "add-host-with-NAT-hide": {
      "description": "Adds simple host with NAT",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.284118",
    "source_file": "add-host.html"
  }
}
```