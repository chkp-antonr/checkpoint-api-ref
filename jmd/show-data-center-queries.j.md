...
```json
{
  "command": "show-data-center-queries",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-center-queries",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-center-queries": {
      "description": "",
      "request": "POST {{server}}/show-data-center-queries\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": "{\n  \"from\" : 1,\n  \"to\" : 1,\n  \"total\" : 1,\n  \"objects\" : [ {\n    \"uid\" : \"4f50908f-4f45-4b70-87a3-2fbd87eca5f7\",\n    \"name\" : \"data-center-query1\",\n    \"type\" : \"data-center-query\",\n    \"domain\" : {\n      \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\",\n      \"name\" : \"SMC User\",\n      \"domain-type\" : \"domain\"\n    }\n  } ]\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.625330",
    "source_file": "show-data-center-queries.html"
  }
}
```