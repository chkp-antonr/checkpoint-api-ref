# set-data-type-compound-group

```json
{
  "command": "set-data-type-compound-group",
  "description": "Edit existing Compound Data Type Group object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-data-type-compound-group",
    "headers": [
      {
        "name": "Content-Type",
