...
```json
{
  "command": "clone-tacacs-server",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-tacacs-server",
    "headers": [
      {
        "name": "Content-Type",
