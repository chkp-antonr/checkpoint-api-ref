...
```json
{
  "command": "show-smart-task",
  "description": "Retrieve existing object using object name or uid. This command is available only in a Security Management environment or in Multi-Domain environment when logged into local domain.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-smart-task",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-smart-task": {
      "description": "",
      "request": "POST {{server}}/show-smart-task\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Validate Session Name Before Publish\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.441691",
    "source_file": "show-smart-task.html"
  }
}
```