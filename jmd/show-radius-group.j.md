...
```json
{
  "command": "show-radius-group",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-radius-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show radius-group": {
      "description": "Show radius group",
      "request": "POST {{server}}/set-radius-group\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"radgroup\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.874472",
    "source_file": "show-radius-group.html"
  }
}
```