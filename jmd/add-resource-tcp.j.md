...
```json
{
  "command": "add-resource-tcp",
  "description": "Create new TCP resource.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-resource-tcp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.499120",
    "source_file": "add-resource-tcp.html"
  }
}
```