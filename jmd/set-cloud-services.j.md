...
```json
{
  ...
  "description": "Set the connection settings between the Management Server and Check Point's Infinity Portal.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-cloud-services",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:16.281194",
    "source_file": "set-cloud-services.html"
  }
}
```