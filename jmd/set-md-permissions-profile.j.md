...
```json
{
  "command": "set-md-permissions-profile",
  "description": "Edit existing Multi-Domain Permissions Profile using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-md-permissions-profile",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-md-permissions-profile": {
      "description": "Change the default profile for all global domains in a Manager permission-level profile",
      "request": "POST {{server}}/set-md-permissions-profile\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"manager profile\",\n  \"permission-level\" : \"domain level only\",\n  \"default-profile-global-domains\" : \"read write all\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.087368",
    "source_file": "set-md-permissions-profile.html"
  }
}
```