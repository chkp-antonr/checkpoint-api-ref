...
```json
{
  "command": "add-interoperable-device",
  "description": "Add new Interoperable Device.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-interoperable-device",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-interoperable-device": {
      "description": "Adds simple Interoperable Device",
    ...
    "add-interoperable-device with default interface": {
      "description": "Adds an Interoperable Device with default interface",
    ...
    "add-interoperable-device with external interface": {
      "description": "Adds an Interoperable Device with external interface",
    ...
    "add-interoperable-device with external interface and anti-spoofing settings changed": {
      "description": "Adds Interoperable Device with external interface and anti-spoofing settings changed",
    ...
    "add-interoperable-device with internal interface and dmz enabled": {
      "description": "Adds Interoperable Device with internal interface and dmz enabled",
    ...
    "add-interoperable-device with IPv4 address": {
      "description": "Adds Interoperable Device with IPv4 address",
      "request": "POST {{server}}/add-interoperable-device\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"NewInteroperableDevice\",\n  \"ipv4-address\" : \"192.168.1.6\"\n}",
    ...
    "add-interoperable-device with IPv4 and IPv6 addresses": {
      "description": "Adds Interoperable Device with IPv4 and IPv6 addresses",
    ...
    "add-interoperable-device with IPv6 address": {
      "description": "Adds Interoperable Device with IPv6 address",
      "request": "POST {{server}}/add-interoperable-device\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"NewInteroperableDevice\",\n  \"ipv6-address\" : \"2001:0db8:85a3:0000:0000:8a2e:0370:7334\"\n}",
      "response": "{\n  \"uid\" : \"0ad7c38d-9738-4782-8e1f-7a6a74c5e8f9\",\n  \"name\" : \"NewInteroperableDevice\",\n  \"type\" : \"interop\",\n  \"domain\" : {\n    \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\",\n    \"name\" : \"SMC User\",\n    \"domain-type\" : \"domain\"\n  },\n  \"meta-info\" : {\n    \"lock\" : \"unlocked\",\n    \"validation-state\" : \"ok\",\n    \"last-modify-time\" : {\n      \"posix\" : 1630481321476,\n      \"iso-8601\" : \"2021-09-01T10:28+0300\"\n    },\n    \"last-modifier\" : \"WEB_API\",\n    \"creation-time\" : {\n      \"posix\" : 1630481321476,\n      \"iso-8601\" : \"2021-09-01T10:28+0300\"\n    },\n    \"creator\" : \"WEB_API\"\n  },\n  \"tags\" : [ ],\n  \"read-only\" : true,\n  \"comments\" : \"\",\n  \"color\" : \"black\",\n  \"icon\" : \"NetworkObjects/gateway\",\n  \"groups\" : [ ],\n  \"ipv4-address\" : \"\",\n  \"ipv6-address\" : \"2001:db8:85a3::8a2e:370:7334\",\n  \"vpn-settings\" : {\n    \"vpn-domain-type\" : \"addresses_behind_gw\"\n  },\n  \"interfaces\" : [ ]\n}"
    },
    "add-interoperable-device with vpn-domain": {
      "description": "Adds Interoperable Device with vpn-domain option",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.577742",
    "source_file": "add-interoperable-device.html"
  }
}
```