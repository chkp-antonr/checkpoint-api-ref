...
```json
{
  "command": "show-dynamic-objects",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-dynamic-objects",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-dynamic-objects": {
      ...
      "request": "POST {{server}}/show-dynamic-objects\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.282074",
    "source_file": "show-dynamic-objects.html"
  }
}
```