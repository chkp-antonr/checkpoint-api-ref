# show-app-control-update-schedule

```json
{
  "command": "show-app-control-update-schedule",
  "description": "Retrieve existing Application Control and URL Filtering update schedule.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-app-control-update-schedule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "response": {
    "success": [
      ...
      {
        "name": "schedule-management-update",
        "description": "",
        "type": "array",
        "required": false
      },
  ...
  "examples": {
    "show-app-control-update-schedule": {
      "description": "Display Application Control & URL Filtering update schedule",
      "request": "POST {{server}}/show-app-control-update-schedule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.925241",
    "source_file": "show-app-control-update-schedule.html"
  }
}
```