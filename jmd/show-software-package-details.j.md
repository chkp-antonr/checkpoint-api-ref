...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-software-package-details",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-software-package-details": {
      "description": "",
      "request": "POST {{server}}/show-software-package-details\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Check_Point_R80_40_JHF_MCD_DEMO_019_MAIN_Bundle_T1_VISIBLE_FULL.tgz\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.491716",
    "source_file": "show-software-package-details.html"
  }
}
```