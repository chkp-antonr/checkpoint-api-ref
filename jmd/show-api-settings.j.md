...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-api-settings",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-api-settings": {
      "description": "",
      "request": "POST {{server}}/show-api-settings\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.848504",
    "source_file": "show-api-settings.html"
  }
}
```