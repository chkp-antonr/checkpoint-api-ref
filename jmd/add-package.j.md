...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-package",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      },
      {
        ...
        "description": "Which Gateways identified by the name or UID to install the policy on. \"All\" - Install the policy on all Gateways.\"[]\" - Empty the list of specified Gateways on which to install the policy.",
        "type": "string",
        "required": false,
        "default": "All"
      },
  ...
  "response": {
    "success": [
      ...
      {
        "name": "installation-targets-revision",
        "description": "",
        "type": "array",
        "required": false,
        "valid_values": [
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.280549",
    "source_file": "add-package.html"
  }
}
```