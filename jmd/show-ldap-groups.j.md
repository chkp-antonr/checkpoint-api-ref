...
```json
{
  "command": "show-ldap-groups",
  "description": "Retrieve all LDAP Groups.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-ldap-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show ldap-groups": {
      "description": "Retrieve all LDAP groups.",
      "request": "POST {{server}}/show-ldap-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 5,\n  \"offset\" : 0,\n  \"details-level\" : \"full\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.730971",
    "source_file": "show-ldap-groups.html"
  }
}
```