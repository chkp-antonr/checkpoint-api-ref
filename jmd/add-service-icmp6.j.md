...
```json
{
  "command": "add-service-icmp6",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-service-icmp6",
    "headers": [
      {
        "name": "Content-Type",
