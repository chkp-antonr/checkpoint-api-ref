...
```json
{
  "command": "add-domain-permissions-profile",
  "description": "Create new Domain Permissions Profile.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-domain-permissions-profile",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-domain-permissions-profile": {
      "description": "Add a Domain Permissions Profile with the default permission-type",
      "request": "POST {{server}}/add-domain-permissions-profile\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"customized profile\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
    ...
    "add-domain-permissions-profile (read only all permission-type)": {
      "description": "Add a Domain Permissions Profile with a Read Only All permission-type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.027734",
    "source_file": "add-domain-permissions-profile.html"
  }
}
```