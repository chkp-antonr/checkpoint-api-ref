...
```json
{
  "command": "show-automatic-purge",
  "description": "Show Automatic Purge.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-automatic-purge",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-automatic-purge by count": {
      "description": "Show scheduled Automatic Purge parameters",
      "request": "POST {{server}}/show-automatic-purge\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.078487",
    "source_file": "show-automatic-purge.html"
  }
}
```