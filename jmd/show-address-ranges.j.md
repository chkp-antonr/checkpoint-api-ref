...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-address-ranges",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-address-ranges": {
      "description": "",
      "request": "POST {{server}}/show-address-ranges\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.752746",
    "source_file": "show-address-ranges.html"
  }
}
```