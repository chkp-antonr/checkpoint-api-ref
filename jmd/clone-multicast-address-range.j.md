...
```json
{
  "command": "clone-multicast-address-range",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-multicast-address-range",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-multicast-address-range": {
      "description": "Clones an existing Multicast Address Range",
      "request": "POST {{server}}/clone-multicast-address-range\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Multicast Address Range\",\n  \"ip-address-first\" : \"224.0.0.7\",\n  \"ip-address-last\" : \"224.0.0.10\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.893614",
    "source_file": "clone-multicast-address-range.html"
  }
}
```