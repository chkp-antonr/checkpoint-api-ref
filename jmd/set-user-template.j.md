...
```json
{
  "command": "set-user-template",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-user-template",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-user-template": {
      "description": "",
      "request": "POST {{server}}/set-user-template\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"myusertemplate\",\n  \"expiration-by-global-properties\" : \"True\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:21.327713",
    "source_file": "set-user-template.html"
  }
}
```