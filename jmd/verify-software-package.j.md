...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/verify-software-package",
    "headers": [
      {
        "name": "Content-Type",
