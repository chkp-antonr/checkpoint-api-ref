...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/discard",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "response": {
    "success": [
      ...
      {
        "name": "number-of-discarded-changes",
  ...
  "examples": {
    "discard": {
      ...
      "request": "POST {{server}}/discard\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": "{\n  \"message\" : \"OK\",\n  \"number-of-discarded-changes\" : 0\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.332278",
    "source_file": "discard.html"
  }
}
```