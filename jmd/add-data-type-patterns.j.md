# add-data-type-patterns

```json
{
  "command": "add-data-type-patterns",
  "description": "Create new Pattern Data Type Object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-data-type-patterns",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.852889",
    "source_file": "add-data-type-patterns.html"
  }
}
```