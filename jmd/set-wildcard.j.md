...
```json
{
  "command": "set-wildcard",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-wildcard",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-wildcard": {
      ...
      "request": "POST {{server}}/set-wildcard\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Wildcard 1\",\n  \"new-name\" : \"New Wildcard 3\",\n  \"color\" : \"green\",\n  \"ipv6-address\" : \"2001:db8::1111\",\n  \"ipv6-mask-wildcard\" : \"ffff:ffff::f0f0\",\n  \"groups\" : \"New Group 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.389573",
    "source_file": "set-wildcard.html"
  }
}
```