...
```json
{
  "command": "add-network-probe",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-network-probe",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-network-probe": {
      "description": "Adds a new Network Probe.",
      "request": "POST {{server}}/add-network-probe\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"probe_GW1\",\n  \"install-on\" : \"GW_1\",\n  \"icmp-options\" : {\n    \"source\" : \"Host_10.10.10.10\",\n    \"destination\" : \"HOST_20.20.20.20\"\n  }\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.112427",
    "source_file": "add-network-probe.html"
  }
}
```