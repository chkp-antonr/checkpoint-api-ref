...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-ips-update-schedule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-ips-update-schedule": {
      ...
      "request": "POST {{server}}/show-ips-update-schedule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": "{\n  \"enabled\" : true,\n  \"time\" : \"0:00\",\n  \"recurrence\" : {\n    \"pattern\" : \"Daily\"\n  }\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.642932",
    "source_file": "show-ips-update-schedule.html"
  }
}
```