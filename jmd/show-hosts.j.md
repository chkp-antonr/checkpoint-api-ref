...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-hosts",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-hosts": {
      "description": "",
      "request": "POST {{server}}/show-hosts\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    },
    "show hosts using filter": {
      "description": "Show hosts using filter.",
      "request": "POST {{server}}/show-hosts\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"filter\" : \"host_\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.037906",
    "source_file": "show-hosts.html"
  }
}
```