...
```json
{
  "command": "show-domain-permissions-profile",
  "description": "Retrieve existing Domain Permissions Profile using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-domain-permissions-profile",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-domain-permissions-profile": {
      "description": "",
      "request": "POST {{server}}/show-domain-permissions-profile\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"profile\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.107652",
    "source_file": "show-domain-permissions-profile.html"
  }
}
```