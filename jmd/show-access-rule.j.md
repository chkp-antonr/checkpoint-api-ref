...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-access-rule",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "package",
        "description": "Policy package name or uid.",
        "type": "string",
        "required": false
      },
      {
  ...
  "examples": {
    "show-access-rule": {
      "description": "",
      "request": "POST {{server}}/show-access-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Rule 1\",\n  \"layer\" : \"Network\"\n}",
      "response": ""
    },
    "show-access-rule as ranges": {
      "description": "Shows the Access Rule with its members displayed as ranges, and not as Check Point Objects.",
      "request": "POST {{server}}/show-access-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Rule 1\",\n  \"layer\" : \"Network\",\n  \"show-as-ranges\" : \"true\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.656582",
    "source_file": "show-access-rule.html"
  }
}
```