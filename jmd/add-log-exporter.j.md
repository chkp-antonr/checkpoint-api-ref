...
```json
{
  "command": "add-log-exporter",
  "description": "Create new log exporter.After you configure a Log Exporter, you must run Install Database.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-log-exporter",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add log-exporter": {
      "description": "Create new log exporter.",
      "request": "POST {{server}}/add-log-exporter\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newLogExporter\",\n  \"target-server\" : \"1.2.3.4\",\n  \"target-port\" : 1234,\n  \"protocol\" : \"tcp\",\n  \"attachments\" : {\n    \"add-link-to-log-attachment\" : true\n  }\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.634787",
    "source_file": "add-log-exporter.html"
  }
}
```