# clone-service-dce-rpc

```json
{
  "command": "clone-service-dce-rpc",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-service-dce-rpc",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.384817",
    "source_file": "clone-service-dce-rpc.html"
  }
}
```