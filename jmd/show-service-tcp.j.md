...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-service-tcp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-service-tcp": {
      "description": "",
      "request": "POST {{server}}/show-service-tcp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"https\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.604472",
    "source_file": "show-service-tcp.html"
  }
}
```