...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-gateway-global-use",
    "headers": [
      {
        "name": "Content-Type",
