...
```json
{
  "command": "show-data-center-servers",
  "description": "Retrieve existing Data Center Servers.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-center-servers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-center-servers": {
      "description": "",
      "request": "POST {{server}}/show-data-center-servers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": "{\n  \"from\" : 1,\n  \"to\" : 1,\n  \"total\" : 1,\n  \"objects\" : [ {\n    \"uid\" : \"d5379ada-c7d7-4678-bf55-0776f33b2326\",\n    \"name\" : \"vCenter 1\",\n    \"type\" : \"data-center-server\",\n    \"domain\" : {\n      \"domain-type\" : \"domain\",\n      \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\",\n      \"name\" : \"SMC User\"\n    }\n  } ]\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.687622",
    "source_file": "show-data-center-servers.html"
  }
}
```