...
```json
{
  "command": "delete-threat-exception",
  "description": "Delete existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/delete-threat-exception",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "delete-threat-exception": {
      ...
      "request": "POST {{server}}/delete-threat-exception\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"rule-number\" : 1,\n  \"exception-number\" : 1,\n  \"layer\" : \"New Layer 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.189031",
    "source_file": "delete-threat-exception.html"
  }
}
```