...
```json
{
  "command": "show-threat-rule",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-threat-rule",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-threat-rule": {
      "description": "",
      "request": "POST {{server}}/show-threat-rule\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"rule-number\" : 1,\n  \"layer\" : \"New Layer 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.999272",
    "source_file": "show-threat-rule.html"
  }
}
```