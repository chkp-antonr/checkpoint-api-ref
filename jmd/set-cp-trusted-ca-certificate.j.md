...
```json
{
  ...
  "description": "Edit existing Check Point trusted CA certificate using name or uid. By default all CP trusted CA certificates are enabled.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-cp-trusted-ca-certificate",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-cp-trusted-ca-certificate": {
      "description": "",
      "request": "POST {{server}}/set-cp-trusted-ca-certificate\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"uid\" : \"c7253c5f-5881-4d4a-b82b-f111b2182403\",\n  \"status\" : \"disabled\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:16.313916",
    "source_file": "set-cp-trusted-ca-certificate.html"
  }
}
```