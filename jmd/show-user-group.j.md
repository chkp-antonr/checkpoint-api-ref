...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-user-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-user-group": {
      "description": "",
      "request": "POST {{server}}/show-user-group\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"myusergroup\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.226609",
    "source_file": "show-user-group.html"
  }
}
```