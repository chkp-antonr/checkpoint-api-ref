...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-group-with-exclusion",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-group-with-exclusion": {
      "description": "",
      "request": "POST {{server}}/set-group-with-exclusion\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Group with exclusion\",\n  \"include\" : \"New Group 2\",\n  \"except\" : \"New Group 1\"\n}",
      "response": ""
    },
    "set-group-with-exclusion (add to group)": {
      "description": "",
      "request": "POST {{server}}/set-group-with-exclusion\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Group with exclusion\",\n  \"groups\" : \"New Group 1\"\n}",
      "response": ""
    }
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:17.202058",
    "source_file": "set-group-with-exclusion.html"
  }
}
```