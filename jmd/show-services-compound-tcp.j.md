...
```json
{
  "command": "show-services-compound-tcp",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-services-compound-tcp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-services-compound-tcp": {
      "description": "",
      "request": "POST {{server}}/show-services-compound-tcp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 10\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.655594",
    "source_file": "show-services-compound-tcp.html"
  }
}
```