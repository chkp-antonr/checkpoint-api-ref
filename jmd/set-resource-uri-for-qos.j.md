...
```json
{
  "command": "set-resource-uri-for-qos",
  "description": "Edit existing Uri For QoS resource using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-resource-uri-for-qos",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.998965",
    "source_file": "set-resource-uri-for-qos.html"
  }
}
```