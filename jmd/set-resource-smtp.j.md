...
```json
{
  "command": "set-resource-smtp",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-resource-smtp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.949084",
    "source_file": "set-resource-smtp.html"
  }
}
```