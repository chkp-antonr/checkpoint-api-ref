...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-services-icmp6",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-services-icmp6": {
      "description": "",
      "request": "POST {{server}}/show-services-icmp6\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 2,\n  \"offset\" : 4\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.708069",
    "source_file": "show-services-icmp6.html"
  }
}
```