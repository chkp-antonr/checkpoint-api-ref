...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-service-groups",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "show-as-ranges",
        "description": "When true, the service group's matched content is displayed as ranges of port numbers rather than service objects.Objects that are not represented using port numbers are presented as objects.The 'members' parameter is omitted from the response and instead the 'ranges' parameter is displayed.",
        "type": "boolean",
        "required": false,
        "default": "false"
      }
  ...
  "examples": {
    "show-service-groups": {
      "description": "",
      "request": "POST {{server}}/show-service-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    },
    "show-service-groups as ranges": {
      "description": "Shows the first 50 service groups with each service group's matched content displayed as ranges of port numbers, and not as Check Point Objects.",
      "request": "POST {{server}}/show-service-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"full\",\n  \"show-as-ranges\" : \"true\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.455259",
    "source_file": "show-service-groups.html"
  }
}
```