...
```json
{
  "command": "revert-to-revision",
  "description": "Revert the Management Database to the selected revision.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/revert-to-revision",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "revert-to-revision": {
      "description": "Revert the Management Database to the selected revision.",
      "request": "POST {{server}}/revert-to-revision\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"to-session\" : \"d49ed10c-649a-476a-8e80-8282eda00e15\"\n}",
      "response": "{\n  \"task-id\" : \"01234567-89ab-cdef-a930-8c37ab9972b3\"\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.645772",
    "source_file": "revert-to-revision.html"
  }
}
```