...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-software-packages-per-targets",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "category",
        "description": "The package categories to include in the results.",
        "type": "string",
        "required": false,
        "default": "all"
      },
      {
        "name": "installed",
        "description": "Show installed packages, available packages, or both.",
        "type": "string",
        "required": false,
        "default": "no",
        "valid_values": [
  ...
  "response": {
    "success": [
      ...
      {
        "name": "uid",
        "description": "The target object unique identifier.",
        "type": "string",
        "required": false
      },
      {
  ...
  "examples": {
    "show-software-packages-per-targets": {
      "description": "",
      "request": "POST {{server}}/show-software-packages-per-targets\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"targets.1\" : \"corporate-gateway\",\n  \"display.installed\" : \"no\",\n  \"display.recommended\" : \"any\",\n  \"display.category\" : \"major\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.501759",
    "source_file": "show-software-packages-per-targets.html"
  }
}
```