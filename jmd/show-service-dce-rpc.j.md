...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-service-dce-rpc",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-service-dce-rpc": {
      "description": "",
      "request": "POST {{server}}/show-service-dce-rpc\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"HP-OpCdistm\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.403747",
    "source_file": "show-service-dce-rpc.html"
  }
}
```