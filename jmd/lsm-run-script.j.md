...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/lsm-run-script",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "LSM Run Script": {
      "description": "",
      "request": "POST {{server}}/lsm-run-script\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"targets\" : [ \"lsm_gateway\" ],\n  \"script\" : \"ls -l /\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.601584",
    "source_file": "lsm-run-script.html"
  }
}
```