...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-multicast-address-range",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-multicast-address-range": {
      ...
      "request": "POST {{server}}/show-multicast-address-range\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Multicast Address Range\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.278897",
    "source_file": "show-multicast-address-range.html"
  }
}
```