...
```json
{
  ...
  "description": "Import an updatable object from the repository to the management server. This operation takes effect immediately and doesn't require publishing.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-updatable-object",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-updatable-object": {
      ...
      "request": "POST {{server}}/add-updatable-object\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"uri\" : \"{{uri}}\"\n}\n\n\u2022 Get value for {{uri}} by getting uri filed from results of the command `show updatable-objects-repository-content`.",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:09.948862",
    "source_file": "add-updatable-object.html"
  }
}
```