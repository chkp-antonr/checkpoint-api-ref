# show-gsn-handover-groups

```json
{
  "command": "show-gsn-handover-groups",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-gsn-handover-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-gsn-handover-groups": {
      "description": "",
      "request": "POST {{server}}/show-gsn-handover-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"details-level\" : \"full\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.959190",
    "source_file": "show-gsn-handover-groups.html"
  }
}
```