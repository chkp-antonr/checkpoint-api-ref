...
```json
{
  "command": "clone-service-other",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-service-other",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "protocol",
        "description": "Protocol name or uid. The protocol type associated with the service, and by implication, the management server (if any) that enforces Content Security and Authentication for the service.To remove, set value to 'none'.",
        "type": "string",
        "required": false
      },
      {
  ...
  "examples": {
    "clone-service-other": {
      "description": "",
      "request": "POST {{server}}/clone-service-other\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New_Service_1\",\n  \"new-name\" : \"New_Service_3\",\n  \"color\" : \"green\",\n  \"aggressive-aging\" : {\n    \"default-timeout\" : 3600\n  }\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.553176",
    "source_file": "clone-service-other.html"
  }
}
```