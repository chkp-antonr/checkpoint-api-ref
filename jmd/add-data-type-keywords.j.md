...
```json
{
  "command": "add-data-type-keywords",
  "description": "Create new Keywords Data Type Object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-data-type-keywords",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.838318",
    "source_file": "add-data-type-keywords.html"
  }
}
```