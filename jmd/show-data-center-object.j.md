...
```json
{
  "command": "show-data-center-object",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-center-object",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-center-object": {
      "description": "",
      "request": "POST {{server}}/show-data-center-object\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"VM1 mgmt name\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.586827",
    "source_file": "show-data-center-object.html"
  }
}
```