...
```json
{
  "command": "show-resources-cifs",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-resources-cifs",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-resources-cifs": {
      "description": "",
      "request": "POST {{server}}/show-resources-cifs\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.138492",
    "source_file": "show-resources-cifs.html"
  }
}
```