...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/check-network-feed",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "check-network-feed with existing feed": {
      "description": "Check Existing Network Feed",
      "request": "POST {{server}}/check-network-feed\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"network-feed\" : {\n    \"name\" : \"existing_feed\"\n  },\n  \"targets\" : \"corporate-gateway\"\n}",
      "response": ""
    },
    "check-network-feed with overrides": {
      "description": "Check Existing Network Feed With Overrides",
      "request": "POST {{server}}/check-network-feed\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"network-feed\" : {\n    \"name\" : \"existing_feed\",\n    \"use-gateway-proxy\" : \"false\",\n    \"feed-type\" : \"Domain\"\n  },\n  \"targets\" : \"corporate-gateway\"\n}",
      "response": ""
    },
    "check-network-feed with new feed": {
      "description": "Check New Network Feed",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.180403",
    "source_file": "check-network-feed.html"
  }
}
```