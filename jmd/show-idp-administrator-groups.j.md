# show-idp-administrator-groups

```json
{
  "command": "show-idp-administrator-groups",
  "description": "Retrieve all Identity Provider administrators groups.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-idp-administrator-groups",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.345201",
    "source_file": "show-idp-administrator-groups.html"
  }
}
```