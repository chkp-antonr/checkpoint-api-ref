...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-gateways-and-servers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "response": {
    "success": [
      ...
      {
        "name": "leads-to-specific-network",
        "description": "",
        "type": "Object",
        "required": false,
        "valid_values": [
      ...
      {
        "name": "zero-phishing",
        "description": "Zero phishing blade.",
        "type": "boolean",
        "required": false
      },
      {
      ...
      {
        "name": "access-policy-installation-date",
        "description": "",
        "type": "Object",
        "required": false
      },
      ...
      {
        "name": "cluster-members-access-policy-revision",
        "description": "",
        "type": "array",
        "required": false,
        "valid_values": [
      ...
      {
        "name": "cluster-members-threat-policy-revision",
        "description": "",
        "type": "array",
        "required": false,
        "valid_values": [
      ...
      {
        "name": "threat-policy-installation-date",
        "description": "",
        "type": "Object",
        "required": false
      },
      ...
      {
        "name": "vpn-encryption-domain-manually-defined",
        "description": "",
        "type": "Object",
        "required": false,
        "valid_values": [
  ...
  "examples": {
    "show-gateways-and-servers": {
      ...
      "request": "POST {{server}}/show-gateways-and-servers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"details-level\" : \"full\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.553124",
    "source_file": "show-gateways-and-servers.html"
  }
}
```