...
```json
{
  "command": "show-data-type-patterns",
  "description": "Retrieve existing Pattern Data Type object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-type-patterns",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-type-patterns": {
      "description": "",
      "request": "POST {{server}}/show-data-type-patterns\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"pattern-obj\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.883378",
    "source_file": "show-data-type-patterns.html"
  }
}
```