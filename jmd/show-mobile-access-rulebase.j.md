...
```json
{
  "command": "show-mobile-access-rulebase",
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-mobile-access-rulebase",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-mobile-access-rulebase": {
      "description": "Showing the Mobile Access rulebase",
      "request": "POST {{server}}/show-mobile-access-rulebase\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"offset\" : 0,\n  \"limit\" : 20,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.197033",
    "source_file": "show-mobile-access-rulebase.html"
  }
}
```