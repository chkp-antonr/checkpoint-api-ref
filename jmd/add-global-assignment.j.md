...
```json
{
  "command": "add-global-assignment",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-global-assignment",
    "headers": [
      {
        "name": "Content-Type",
