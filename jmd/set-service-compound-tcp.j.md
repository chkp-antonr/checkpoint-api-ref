...
```json
{
  "command": "set-service-compound-tcp",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-service-compound-tcp",
    "headers": [
      {
        "name": "Content-Type",
