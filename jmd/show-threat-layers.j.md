...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-threat-layers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-threat-layers": {
      ...
      "request": "POST {{server}}/show-threat-layers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.865379",
    "source_file": "show-threat-layers.html"
  }
}
```