...
```json
{
  "command": "show-log-exporter",
  "description": "Retrieve existing log exporter using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-log-exporter",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show log-exporter": {
      "description": "Retrieve existing log exporter.",
      "request": "POST {{server}}/show-log-exporter\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newLogExporter\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.772783",
    "source_file": "show-log-exporter.html"
  }
}
```