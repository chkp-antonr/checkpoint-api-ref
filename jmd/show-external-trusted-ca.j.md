...
```json
{
  "command": "show-external-trusted-ca",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-external-trusted-ca",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show external-trusted-ca": {
      "description": "Show external trusted ca",
      "request": "POST {{server}}/show-external-trusted-ca\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"external_ca\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.338525",
    "source_file": "show-external-trusted-ca.html"
  }
}
```