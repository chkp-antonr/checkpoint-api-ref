...
```json
{
  "command": "show-threat-indicator",
  "description": "Displays a Threat-Indicator.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-threat-indicator",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "response": {
    "success": [
      ...
      {
        "name": "number-of-observables",
        "description": "The amount of observables in the indicator.",
        "type": "integer",
        "required": false
      },
      {
        "name": "observables-raw-data",
        "description": "The contents of the file containing the indicator's observables.Available only when details-level is full.",
        "type": "string",
        "required": false
      },
      {
  ...
  "examples": {
    "show-threat-indicator": {
      ...
      "request": "POST {{server}}/show-threat-indicator\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"My_Indicator\"\n}",
      "response": "{\n  \"uid\" : \"7c00fba4-978e-4769-acbf-46909b88f45d\",\n  \"name\" : \"My_Indicator\",\n  \"type\" : \"threat-indicator\",\n  \"domain\" : {\n    \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\",\n    \"name\" : \"SMC User\",\n    \"domain-type\" : \"domain\"\n  },\n  \"meta-info\" : {\n    \"lock\" : \"locked by current session\",\n    \"validation-state\" : \"ok\",\n    \"last-modify-time\" : {\n      \"posix\" : 1493293547036,\n      \"iso-8601\" : \"2017-04-27T14:45+0300\"\n    },\n    \"last-modifier\" : \"aa\",\n    \"creation-time\" : {\n      \"posix\" : 1493293547036,\n      \"iso-8601\" : \"2017-04-27T14:45+0300\"\n    },\n    \"creator\" : \"aa\"\n  },\n  \"tags\" : [ ],\n  \"read-only\" : false,\n  \"comments\" : \"\",\n  \"icon\" : \"General/Node\",\n  \"action\" : \"Ask\",\n  \"number-of-observables\" : 1\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.781171",
    "source_file": "show-threat-indicator.html"
  }
}
```