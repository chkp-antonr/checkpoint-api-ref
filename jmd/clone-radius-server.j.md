...
```json
{
  "command": "clone-radius-server",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-radius-server",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "enable-ip-pool-management",
  ...
  "examples": {
    "clone radius-server": {
      "description": "Clone radius server",
      "request": "POST {{server}}/clone-radius-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"test\",\n  \"shared-secret\" : \"123\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.062709",
    "source_file": "clone-radius-server.html"
  }
}
```