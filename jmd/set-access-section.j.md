...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-access-section",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-access-section": {
      "description": "",
      "request": "POST {{server}}/set-access-section\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"layer\" : \"Network\",\n  \"name\" : \"New Section 1\",\n  \"new-name\" : \"New Section 2\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.919726",
    "source_file": "set-access-section.html"
  }
}
```