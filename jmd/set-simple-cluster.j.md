...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-simple-cluster",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-simple-cluster add interface": {
      "description": "Add interface to cluster and all members",
      "request": "POST {{server}}/set-simple-cluster\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"cluster1\",\n  \"interfaces\" : {\n    \"add\" : {\n      \"name\" : \"eth3\",\n      \"ip-address\" : \"10.10.10.1\",\n      \"ipv4-mask-length\" : \"24\",\n      \"interface-type\" : \"cluster\",\n      \"topology\" : \"INTERNAL\",\n      \"anti-spoofing\" : \"true\"\n    }\n  },\n  \"members\" : {\n    \"update\" : [ {\n      \"name\" : \"member1\",\n      \"interfaces\" : {\n        \"name\" : \"eth3\",\n        \"ipv4-address\" : \"10.10.10.2\",\n        \"ipv4-network-mask\" : \"255.255.255.0\"\n      }\n    }, {\n      \"name\" : \"member2\",\n      \"interfaces\" : {\n        \"name\" : \"eth3\",\n        \"ipv4-address\" : \"10.10.10.3\",\n        \"ipv4-network-mask\" : \"255.255.255.0\"\n      }\n    } ]\n  }\n}",
    ...
    "set-simple-cluster set advanced ClusterXL settings": {
      "description": "Set ClusterXL advanced settings",
    ...
    "set-simple-cluster change member priority": {
      "description": "Change cluster member priority. Set 1 for member with highest priority. Set 3, in case of cluster with 3 members, for lowest priority member",
      "request": "POST {{server}}/set-simple-cluster\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"cluster1\",\n  \"members\" : {\n    \"update\" : [ {\n      \"name\" : \"mem1\",\n      \"priority\" : 1\n    }, {\n      \"name\" : \"mem2\",\n      \"priority\" : 3\n    } ]\n  }\n}",
      "response": "{\n  \"tasks\" : [ {\n    \"task-name\" : \"set simple-cluster\",\n    \"task-id\" : \"01234567-89ab-1234-8c24-e81fed34664a\",\n    \"status\" : \"succeeded\",\n    \"progress-percentage\" : 100,\n    \"suppressed\" : false,\n    \"task-details\" : [ {\n      \"message\" : \"Successfully finished\"\n    } ]\n  } ]\n}"
    },
    ...
    "set-simple-cluster scale down": {
      "description": "Remove a member from the cluster (scale down)",
      "request": "POST {{server}}/set-simple-cluster\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"cluster1\",\n  \"members\" : {\n    \"remove\" : \"member3\"\n  }\n}",
      "response": "{\n  \"task-id\" : \"01234567-89ab-abcd-1234-58dc02112100\"\n}"
    },
    "set-simple-cluster scale up": {
      "description": "Scale up simple cluster with an additional member",
      "request": "POST {{server}}/set-simple-cluster\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"cluster1\",\n  \"members\" : {\n    \"add\" : {\n      \"name\" : \"member3\",\n      \"ipv4-address\" : \"17.23.5.4\",\n      \"one-time-password\" : \"aaaa\",\n      \"interfaces\" : [ {\n        \"name\" : \"eth0\",\n        \"ip-address\" : \"17.23.5.4\",\n        \"network-mask\" : \"255.255.255.0\"\n      }, {\n        \"name\" : \"eth1\",\n        \"ip-address\" : \"1.1.2.6\",\n        \"network-mask\" : \"255.255.255.0\"\n      }, {\n        \"name\" : \"eth2\",\n        \"ip-address\" : \"192.168.1.4\",\n        \"network-mask\" : \"255.255.255.0\"\n      } ]\n    }\n  }\n}",
      "response": "{\n  \"task-id\" : \"01234567-89ab-abcd-1234-58dc02112100\"\n}"
    },
    "set-simple-cluster establish SIC": {
      "description": "Establish SIC with existing cluster members",
      "request": "POST {{server}}/set-simple-cluster\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"cluster1\",\n  \"members\" : {\n    \"update\" : [ {\n      \"name\" : \"member1\",\n      \"one-time-password\" : \"abcd\"\n    }, {\n      \"name\" : \"member2\",\n      \"one-time-password\" : \"abcd\"\n    } ]\n  }\n}",
      "response": ""
    },
    "set-simple-cluster (remove Enhanced Link Selection Interfaces)": {
      "description": "Modifies an existing cluster with Enhanced Link Selection Interfaces (Remove Action)",
    ...
    "set-simple-cluster remove interface": {
      "description": "Remove the interface from cluster and all members",
      "request": "POST {{server}}/set-simple-cluster\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"cluster1\",\n  \"interfaces\" : {\n    \"remove\" : \"eth3\"\n  }\n}",
      "response": "{\n  \"task-id\" : \"01234567-89ab-abcd-1234-58dc02112100\"\n}"
    },
    ...
    "set-simple-cluster renew vpn certificate": {
      "description": "",
      "request": "POST {{server}}/set-simple-cluster\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"cluster1\",\n  \"vpn-settings\" : {\n    \"certificates\" : {\n      \"renew\" : {\n        \"name\" : \"defaultCert\",\n        \"alternate-names\" : [ {\n          \"type\" : \"ip address\",\n          \"value\" : \"2.2.2.2\"\n        }, {\n          \"type\" : \"email\",\n          \"value\" : \"new_email\"\n        } ]\n      }\n    }\n  }\n}",
    ...
    "set-simple-cluster replace all interfaces": {
      "description": "Replace all cluster and members interfaces with new interfaces",
      "request": "POST {{server}}/set-simple-cluster\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"cluster1\",\n  \"interfaces\" : [ {\n    \"name\" : \"eth0\",\n    \"ip-address\" : \"1.1.1.1\",\n    \"network-mask\" : \"255.255.255.0\",\n    \"interface-type\" : \"cluster\",\n    \"topology\" : \"EXTERNAL\",\n    \"anti-spoofing\" : \"false\"\n  }, {\n    \"name\" : \"eth1\",\n    \"ip-address\" : \"2.2.2.1\",\n    \"network-mask\" : \"255.255.255.0\",\n    \"interface-type\" : \"cluster\",\n    \"topology\" : \"INTERNAL\",\n    \"anti-spoofing\" : \"false\"\n  } ],\n  \"members\" : {\n    \"update\" : [ {\n      \"name\" : \"member1\",\n      \"ip-address\" : \"1.1.1.2\",\n      \"interfaces\" : [ {\n        \"name\" : \"eth0\",\n        \"ipv4-address\" : \"1.1.1.2\",\n        \"ipv4-network-mask\" : \"255.255.255.0\"\n      }, {\n        \"name\" : \"eth1\",\n        \"ipv4-address\" : \"2.2.2.2\",\n        \"ipv4-network-mask\" : \"255.255.255.0\"\n      } ]\n    }, {\n      \"name\" : \"member2\",\n      \"ip-address\" : \"1.1.1.3\",\n      \"interfaces\" : [ {\n        \"name\" : \"eth0\",\n        \"ipv4-address\" : \"1.1.1.3\",\n        \"ipv4-network-mask\" : \"255.255.255.0\"\n      }, {\n        \"name\" : \"eth1\",\n        \"ipv4-address\" : \"2.2.2.3\",\n        \"ipv4-network-mask\" : \"255.255.255.0\"\n      } ]\n    } ]\n  }\n}",
      "response": "{\n  \"task-id\" : \"01234567-89ab-abcd-1234-58dc02112100\"\n}"
    },
    "set-simple-cluster replace all members and interfaces": {
      "description": "Replace all cluster members and all interfaces",
      "request": "POST {{server}}/set-simple-cluster\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"cluster1\",\n  \"interfaces\" : [ {\n    \"name\" : \"eth-0\",\n    \"ip-address\" : \"17.2.9.1\",\n    \"network-mask\" : \"255.255.255.0\",\n    \"interface-type\" : \"cluster\",\n    \"topology\" : \"EXTERNAL\",\n    \"anti-spoofing\" : true\n  }, {\n    \"name\" : \"eth-1\",\n    \"interface-type\" : \"sync\",\n    \"topology\" : \"INTERNAL\"\n  }, {\n    \"name\" : \"eth-2\",\n    \"ip-address\" : \"192.168.99.1\",\n    \"network-mask\" : \"255.255.255.0\",\n    \"interface-type\" : \"cluster\",\n    \"topology\" : \"INTERNAL\",\n    \"anti-spoofing\" : true\n  } ],\n  \"members\" : [ {\n    \"name\" : \"mem-1\",\n    \"one-time-password\" : \"aaaa\",\n    \"ip-address\" : \"17.2.6.9\",\n    \"interfaces\" : [ {\n      \"name\" : \"eth-0\",\n      \"ip-address\" : \"17.2.6.10\",\n      \"network-mask\" : \"255.255.255.0\"\n    }, {\n      \"name\" : \"eth-1\",\n      \"ip-address\" : \"1.1.99.4\",\n      \"network-mask\" : \"255.255.255.0\"\n    }, {\n      \"name\" : \"eth-2\",\n      \"ip-address\" : \"192.168.99.2\",\n      \"network-mask\" : \"255.255.255.0\"\n    } ]\n  }, {\n    \"name\" : \"mem-2\",\n    \"one-time-password\" : \"aaaa\",\n    \"ip-address\" : \"17.2.6.8\",\n    \"interfaces\" : [ {\n      \"name\" : \"eth-0\",\n      \"ip-address\" : \"17.2.6.49\",\n      \"network-mask\" : \"255.255.255.0\"\n    }, {\n      \"name\" : \"eth-1\",\n      \"ip-address\" : \"1.1.99.5\",\n      \"network-mask\" : \"255.255.255.0\"\n    }, {\n      \"name\" : \"eth-2\",\n      \"ip-address\" : \"192.168.99.3\",\n      \"network-mask\" : \"255.255.255.0\"\n    } ]\n  } ]\n}",
      "response": "{\n  \"task-id\" : \"01234567-89ab-abcd-1234-58dc02112100\"\n}"
    },
    "set-simple-cluster (set Enhanced Link Selection Interfaces)": {
      "description": "Modifies an existing cluster with Enhanced Link Selection Interfaces (Set Action)",
    ...
    "set-simple-cluster update interface": {
      "description": "Update an existing cluster interface. Change any of the interface settings except for the interface name",
    ...
    "set-simple-cluster with NAT hide": {
      "description": "Set simple cluster with NAT",
      "request": "POST {{server}}/set-simple-cluster\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"cluster1\",\n  \"nat-hide-internal-interfaces\" : true,\n  \"nat-settings\" : {\n    \"auto-rule\" : true,\n    \"method\" : \"hide\",\n    \"hide-behind\" : \"ip-address\",\n    \"ipv4-address\" : \"192.0.2.1\",\n    \"install-on\" : \"All\"\n  }\n}",
      "response": ""
    },
    "set-simple-cluster with proxy": {
      "description": "set simple cluster with proxy settings",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:19.958134",
    "source_file": "set-simple-cluster.html"
  }
}
```