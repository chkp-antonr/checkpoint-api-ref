...
```json
{
  "command": "set-service-icmp6",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-service-icmp6",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-service-icmp6": {
      "description": "",
      "request": "POST {{server}}/set-service-icmp6\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"icmp1\",\n  \"new-name\" : \"icmp2\",\n  \"icmp-type\" : 45,\n  \"icmp-code\" : 13\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:19.333172",
    "source_file": "set-service-icmp6.html"
  }
}
```