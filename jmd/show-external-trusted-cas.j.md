...
```json
{
  "command": "show-external-trusted-cas",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-external-trusted-cas",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show external-trusted-cas": {
      "description": "Show external trusted cas",
      "request": "POST {{server}}/show-external-trusted-cas\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.357371",
    "source_file": "show-external-trusted-cas.html"
  }
}
```