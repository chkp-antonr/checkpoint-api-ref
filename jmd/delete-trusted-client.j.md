...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/delete-trusted-client",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "delete-trusted-client": {
      "description": "",
      "request": "POST {{server}}/delete-trusted-client\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"my client\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.269775",
    "source_file": "delete-trusted-client.html"
  }
}
```