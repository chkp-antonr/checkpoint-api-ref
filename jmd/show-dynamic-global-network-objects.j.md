...
```json
{
  "command": "show-dynamic-global-network-objects",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-dynamic-global-network-objects",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.242522",
    "source_file": "show-dynamic-global-network-objects.html"
  }
}
```