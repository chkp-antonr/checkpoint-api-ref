...
```json
{
  "command": "show-infinity-idps",
  "description": "Retrieve all Infinity Identity Provider from the Infinity Portal.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-infinity-idps",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.485880",
    "source_file": "show-infinity-idps.html"
  }
}
```