...
```json
{
  "command": "set-if-map-server",
  "description": "Edit existing IF-MAP server using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-if-map-server",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "username",
        "description": "Username for the IF-MAP server authentication. Required only when 'authentication-method' is set to 'basic'.",
        "type": "string",
        "required": false
      },
      {
  ...
  "examples": {
    "set if-map-server": {
      "description": "Edit existing IF-MAP server.",
      "request": "POST {{server}}/set-if-map-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"TestIfMapServer\",\n  \"host\" : \"TestHost2\",\n  \"port\" : 2,\n  \"version\" : 1.1,\n  \"path\" : \"newPath\",\n  \"monitored-ips\" : [ {\n    \"first-ip\" : \"3.1.1.1\",\n    \"last-ip\" : \"3.1.1.2\"\n  } ],\n  \"query-whole-ranges\" : false\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:17.654069",
    "source_file": "set-if-map-server.html"
  }
}
```