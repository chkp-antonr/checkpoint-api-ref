...
```json
{
  "command": "set-network-feed",
  "description": "Edit an existing Network Feed.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-network-feed",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    ...
    "set-network-feed - JSON with parsing settings": {
      "description": "Setting JSON with parsing settings",
      "request": "POST {{server}}/set-network-feed\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"network_feed\",\n  \"feed-url\" : \"https://www.feedsresource.com/new_resource\",\n  \"username\" : \"new_username\",\n  \"password\" : \"new_password\",\n  \"feed-format\" : \"JSON\",\n  \"feed-type\" : \"Domain\",\n  \"update-interval\" : 60,\n  \"json-query\" : \".[]|.domains\",\n  \"use-gateway-proxy\" : false,\n  \"custom-header\" : [ {\n    \"header-name\" : \"new_header\",\n    \"header-value\" : \"new_value\"\n  } ]\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.515367",
    "source_file": "set-network-feed.html"
  }
}
```