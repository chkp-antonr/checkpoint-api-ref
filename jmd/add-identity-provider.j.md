...
```json
{
  "command": "add-identity-provider",
  "description": "Create new SAML Identity Provider.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-identity-provider",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    ...
    "add identity provider with metadata file": {
      "description": "Create new identity provider with metadata file.",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.395369",
    "source_file": "add-identity-provider.html"
  }
}
```