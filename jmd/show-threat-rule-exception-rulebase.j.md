...
```json
{
  "command": "show-threat-rule-exception-rulebase",
  "description": "Shows the entire Threat Exceptions layer generated for a given threat rule.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-threat-rule-exception-rulebase",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-threat-rule-exception-rulebase": {
      ...
      "request": "POST {{server}}/show-threat-rule-exception-rulebase\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Standard Threat Prevention\",\n  \"rule-number\" : 1\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.960982",
    "source_file": "show-threat-rule-exception-rulebase.html"
  }
}
```