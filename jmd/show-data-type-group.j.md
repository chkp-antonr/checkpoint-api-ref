...
```json
{
  "command": "show-data-type-group",
  "description": "Retrieve existing Data Group Type object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-type-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-type-group": {
      "description": "",
      "request": "POST {{server}}/show-data-type-group\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"data-group-obj\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.824088",
    "source_file": "show-data-type-group.html"
  }
}
```