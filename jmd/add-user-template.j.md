...
```json
{
  "command": "add-user-template",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-user-template",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-user-template": {
      "description": "",
      "request": "POST {{server}}/add-user-template\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"myusertemplate\",\n  \"expiration-date\" : \"2030-05-30\",\n  \"expiration-by-global-properties\" : \"False\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:10.003262",
    "source_file": "add-user-template.html"
  }
}
```