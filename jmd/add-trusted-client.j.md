...
```json
{
  "command": "add-trusted-client",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-trusted-client",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "multi-domain-server-trusted-client",
  ...
  "response": {
    "success": [
      ...
      {
        "name": "ipv4-address-first",
        "description": "First IPv4 address in the range.",
        "type": "string",
        "required": false
      },
      {
        "name": "ipv4-address-last",
      ...
      {
        "name": "ipv6-address-first",
        "description": "First IPv6 address in the range.",
        "type": "string",
        "required": false
      },
      {
        "name": "ipv6-address-last",
  ...
  "examples": {
    "add-trusted-client": {
      "description": "",
      "request": "POST {{server}}/add-trusted-client\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"my client\",\n  \"type\" : \"ANY\"\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    },
    "add-trusted-client (with domain)": {
      "description": "Add a domain to a trusted client.In the example below, add the domain \"my domain\" to the trusted client \"my client\".Note \u2013 Add domain using the domain name and not an UID.",
      "request": "POST {{server}}/add-trusted-client\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"my client\",\n  \"domains-assignment\" : {\n    \"add\" : \"my domain\"\n  }\n}\n\n \u2022 This command is available only after logging in to the System Data domain.",
      "response": ""
    },
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:09.932502",
    "source_file": "add-trusted-client.html"
  }
}
```