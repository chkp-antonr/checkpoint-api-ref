...
```json
{
  "command": "add-data-type-file-attributes",
  "description": "Create new File Attributes Data Type Object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-data-type-file-attributes",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.803900",
    "source_file": "add-data-type-file-attributes.html"
  }
}
```