...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-gateway-global-use",
    "headers": [
      {
        "name": "Content-Type",
