...
```json
{
  "command": "show-vpn-community-meshed",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-vpn-community-meshed",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-vpn-community-meshed": {
      ...
      "request": "POST {{server}}/show-vpn-community-meshed\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"vpnCommunityMeshed\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.590753",
    "source_file": "show-vpn-community-meshed.html"
  }
}
```