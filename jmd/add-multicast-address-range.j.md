...
```json
{
  "command": "add-multicast-address-range",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-multicast-address-range",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    ...
    "add-multicast-address-range-single-ip": {
      "description": "Adds a new Multicast Address Range using a single IP Address",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.969864",
    "source_file": "add-multicast-address-range.html"
  }
}
```