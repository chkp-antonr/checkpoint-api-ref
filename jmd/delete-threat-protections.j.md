...
```json
{
  "command": "delete-threat-protections",
  "description": "Deletes threat protections.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/delete-threat-protections",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "delete-threat-protections": {
      ...
      "request": "POST {{server}}/delete-threat-protections\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"package-format\" : \"snort\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.233773",
    "source_file": "delete-threat-protections.html"
  }
}
```