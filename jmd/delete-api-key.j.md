...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/delete-api-key",
    "headers": [
      {
        "name": "Content-Type",
