...
```json
{
  "command": "show-data-type-keywords",
  "description": "Retrieve existing Keywords Data Type object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-type-keywords",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "response": {
    "success": [
      ...
      {
        "name": "keywords",
        "description": "Specify keywords or phrases to search for.",
        "type": "array",
        "required": false
      },
      {
        "name": "data-match-threshold",
  ...
  "examples": {
    "show-data-type-keywords": {
      "description": "",
      "request": "POST {{server}}/show-data-type-keywords\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"keywords_obj\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.859763",
    "source_file": "show-data-type-keywords.html"
  }
}
```