...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/install-lsm-settings",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "Install LSM Settings": {
      "description": "",
      "request": "POST {{server}}/install-lsm-settings\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"targets\" : [ \"lsm_gateway\" ]\n}",
      "response": "{\n  \"tasks\" : [ {\n    \"task-id\" : \"01234567-89ab-cdef-bb46-4530fa75c5bb\",\n    \"task-name\" : \"Run Command operation\",\n    \"status\" : \"succeeded\",\n    \"progress-percentage\" : 100,\n    \"suppressed\" : false,\n    \"task-details\" : [ {\n      \"title\" : \"Run command Install LSM Settings succeeded\",\n      \"target\" : \"lsm_gateway\",\n      \"messages\" : [ \"The action has been completed successfully\" ]\n    } ]\n  } ]\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:15.497547",
    "source_file": "install-lsm-settings.html"
  }
}
```