...
```json
{
  "command": "add-radius-group",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-radius-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add radius-group": {
      "description": "Add radius group",
      "request": "POST {{server}}/add-radius-group\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"radgroup\",\n  \"members\" : [ \"t4\", \"radgroup\" ]\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.325141",
    "source_file": "add-radius-group.html"
  }
}
```