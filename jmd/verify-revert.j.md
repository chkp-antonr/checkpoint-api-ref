...
```json
{
  ...
  "examples": {
    "verify-revert": {
      "description": "Verify the Management Database can revert to the selected revision.",
      "request": "POST {{server}}/verify-revert\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"to-session\" : \"d49ed10c-649a-476a-8e80-8282eda00e15\"\n}",
      "response": "{\n  \"task-id\" : \"01234567-89ab-cdef-a930-8c37ac9972b3\"\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.931944",
    "source_file": "verify-revert.html"
  }
}
```