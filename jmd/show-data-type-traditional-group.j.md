# show-data-type-traditional-group

```json
{
  "command": "show-data-type-traditional-group",
  "description": "Retrieve existing Traditional Group Data Type using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-type-traditional-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-type-traditional-group": {
      "description": "",
      "request": "POST {{server}}/show-data-type-traditional-group\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"trad-group-obj\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.904816",
    "source_file": "show-data-type-traditional-group.html"
  }
}
```