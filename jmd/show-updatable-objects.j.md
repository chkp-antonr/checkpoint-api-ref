...
```json
{
  "command": "show-updatable-objects",
  "description": "Retrieves all Updatable Objects that were imported to the Management Server.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-updatable-objects",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-updatable-objects": {
      ...
      "request": "POST {{server}}/show-updatable-objects\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.205571",
    "source_file": "show-updatable-objects.html"
  }
}
```