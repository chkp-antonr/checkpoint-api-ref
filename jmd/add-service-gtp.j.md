...
```json
{
  "command": "add-service-gtp",
  "description": "Create a new GTP service object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-service-gtp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    ...
    "add-service-gtp with Access Point Name": {
      "description": "Add GTP service with match by Access Point Name",
    ...
    "add-service-gtp with Custom Interface Profile and the custom messages": {
      "description": "Add GTP service with Custom Interface Profile and the custom messages",
    ...
    "add-service-gtp with group": {
      "description": "Add GTP service and insert it to an existing ServiceGroup",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:08.790098",
    "source_file": "add-service-gtp.html"
  }
}
```