...
```json
{
  "command": "show-mobile-profiles",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-mobile-profiles",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-mobile-profiles": {
      "description": "",
      "request": "POST {{server}}/show-mobile-profiles\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.256039",
    "source_file": "show-mobile-profiles.html"
  }
}
```