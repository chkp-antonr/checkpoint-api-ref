...
```json
{
  "command": "set-lsv-profile",
  "description": "Set LSV Profile object's fields. Set CA by uid or name, change peers limit or restrict encryption domain.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-lsv-profile",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.060157",
    "source_file": "set-lsv-profile.html"
  }
}
```