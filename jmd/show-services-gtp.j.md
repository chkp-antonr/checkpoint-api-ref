...
```json
{
  "command": "show-services-gtp",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-services-gtp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-services-gtp": {
      "description": "",
      "request": "POST {{server}}/show-services-gtp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 10,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.681439",
    "source_file": "show-services-gtp.html"
  }
}
```