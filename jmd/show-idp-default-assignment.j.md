...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-idp-default-assignment",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show idp-default-assignment": {
      "description": "show idp-default-assignment",
      "request": "POST {{server}}/show-idp-default-assignment\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }\n\n \u2022 This command is available only after logging in to the System Data domain.",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.358190",
    "source_file": "show-idp-default-assignment.html"
  }
}
```