# show-azure-ad-content

```json
{
  "command": "show-azure-ad-content",
  "description": "Retrieve Microsoft Entra ID Objects from the Microsoft Entra ID Server (formerly, Azure AD).",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-azure-ad-content",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-azure-ad-content": {
      "description": "",
      "request": "POST {{server}}/show-azure-ad-content\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"azure-ad-name\" : \"my_azureAD\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.102123",
    "source_file": "show-azure-ad-content.html"
  }
}
```