...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-simple-gateways",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-simple-gateways": {
      "description": "",
      "request": "POST {{server}}/show-simple-gateways\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.335700",
    "source_file": "show-simple-gateways.html"
  }
}
```