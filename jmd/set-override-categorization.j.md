...
```json
{
  "command": "set-override-categorization",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-override-categorization",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-override-categorization": {
      "description": "",
      "request": "POST {{server}}/set-override-categorization\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"url\" : \"newOverride\",\n  \"risk\" : \"high\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.685833",
    "source_file": "set-override-categorization.html"
  }
}
```