...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-access-section",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-access-section": {
      "description": "",
      "request": "POST {{server}}/add-access-section\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"layer\" : \"Network\",\n  \"position\" : 1,\n  \"name\" : \"New Section 1\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.450258",
    "source_file": "add-access-section.html"
  }
}
```