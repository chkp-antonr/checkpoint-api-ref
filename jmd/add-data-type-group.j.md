...
```json
{
  "command": "add-data-type-group",
  "description": "Create new Data Group Type Object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-data-type-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.822825",
    "source_file": "add-data-type-group.html"
  }
}
```