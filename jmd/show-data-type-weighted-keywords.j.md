...
```json
{
  "command": "show-data-type-weighted-keywords",
  "description": "Retrieve existing Weighted Keywords Data Type object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-type-weighted-keywords",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.942998",
    "source_file": "show-data-type-weighted-keywords.html"
  }
}
```