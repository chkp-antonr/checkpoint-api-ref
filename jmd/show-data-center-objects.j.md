...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-center-objects",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-center-objects": {
      "description": "",
      "request": "POST {{server}}/show-data-center-objects\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.606034",
    "source_file": "show-data-center-objects.html"
  }
}
```