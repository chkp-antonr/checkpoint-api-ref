# clone-identity-provider

```json
{
  "command": "clone-identity-provider",
  "description": "Clone existing SAML Identity Provider.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-identity-provider",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone identity-provider": {
      "description": "Clone existing identity provider.",
      "request": "POST {{server}}/clone-identity-provider\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"TestIdp\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.736875",
    "source_file": "clone-identity-provider.html"
  }
}
```