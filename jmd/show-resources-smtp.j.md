...
```json
{
  "command": "show-resources-smtp",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-resources-smtp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-resources-smtp": {
      "description": "",
      "request": "POST {{server}}/show-resources-smtp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.184490",
    "source_file": "show-resources-smtp.html"
  }
}
```