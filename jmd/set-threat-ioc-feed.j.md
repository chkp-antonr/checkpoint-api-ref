...
```json
{
  "command": "set-threat-ioc-feed",
  "description": "Edit an existing threat IOC feed.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-threat-ioc-feed",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "custom-comment",
        "description": "Custom IOC feed - the column number of comment. Set 0 when there is no such column.",
        "type": "integer",
        "required": false,
        "valid_values": [
          "0-100"
      ...
      {
        "name": "custom-name",
        "description": "Custom IOC feed - the column number of name. Set 0 when there is no such column.",
        "type": "integer",
        "required": false,
        "valid_values": [
          "0-100"
      ...
      },
      {
        ...
        "description": "Custom IOC feed - the column number of severity. Set 0 when there is no such column.",
        "type": "integer",
        "required": false,
        "valid_values": [
          "0-100"
  ...
  "examples": {
    ...
    "set-threat-ioc-feed (Simple)": {
      "description": "Setting a simple threat IOC feed",
      "request": "POST {{server}}/set-threat-ioc-feed\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"ioc_feed\",\n  \"use-gateway-proxy\" : false,\n  \"action\" : \"detect\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:20.785911",
    "source_file": "set-threat-ioc-feed.html"
  }
}
```