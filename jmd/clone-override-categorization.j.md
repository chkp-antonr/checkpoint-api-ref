...
```json
{
  "command": "clone-override-categorization",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-override-categorization",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-override-categorization": {
      "description": "",
      "request": "POST {{server}}/clone-override-categorization\nContent-Type: application/json\nSes: \nX-chkp-sid: {{session}}\n\n{\n  \"url\" : \"newOverride\",\n  \"new-url\" : \"clonedOverride\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.996732",
    "source_file": "clone-override-categorization.html"
  }
}
```