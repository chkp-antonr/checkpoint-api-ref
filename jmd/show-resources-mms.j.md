...
```json
{
  "command": "show-resources-mms",
  "description": "Shows a list of all MMS resources.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-resources-mms",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-resources-mms": {
      "description": "",
      "request": "POST {{server}}/show-resources-mms\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.170239",
    "source_file": "show-resources-mms.html"
  }
}
```