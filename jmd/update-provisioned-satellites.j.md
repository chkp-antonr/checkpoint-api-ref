...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/update-provisioned-satellites",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "Update Provisioned Satellites": {
      "description": "",
      "request": "POST {{server}}/update-provisioned-satellites\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"vpn-center-gateways\" : [ \"co_gateway\" ]\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.897425",
    "source_file": "update-provisioned-satellites.html"
  }
}
```