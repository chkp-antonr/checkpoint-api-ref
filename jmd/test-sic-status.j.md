...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/test-sic-status",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "test-sic-status": {
      "description": "Test SIC status of gateway, output indicates state of the gateway which is communicating",
      "request": "POST {{server}}/test-sic-status\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"gw1\"\n}",
      "response": "{\n  \"sic-status:\" : \"SIC Status for gw1: Communicating\"\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.856227",
    "source_file": "test-sic-status.html"
  }
}
```