...
```json
{
  "command": "set-updatable-object",
  "description": "Edit existing Updatable Object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-updatable-object",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:21.156674",
    "source_file": "set-updatable-object.html"
  }
}
```