...
```json
{
  "command": "set-application-site-category",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-application-site-category",
    "headers": [
      {
        "name": "Content-Type",
