# show-gaia-best-practices

```json
{
  "command": "show-gaia-best-practices",
  "description": "Show all Gaia Best Practices.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-gaia-best-practices",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-gaia-best-practice": {
      "description": "Show all Gaia Best Practices.",
      "request": "POST {{server}}/show-gaia-best-practices\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.414231",
    "source_file": "show-gaia-best-practices.html"
  }
}
```