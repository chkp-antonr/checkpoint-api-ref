...
```json
{
  "command": "show-override-categorization",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-override-categorization",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-override-categorization": {
      "description": "",
      "request": "POST {{server}}/show-override-categorization\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"url\" : \"newOverride\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.696243",
    "source_file": "show-override-categorization.html"
  }
}
```