# show-service-compound-tcp

```json
{
  "command": "show-service-compound-tcp",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-service-compound-tcp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-service-compound-tcp": {
      "description": "",
      "request": "POST {{server}}/show-service-compound-tcp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"mycompoundtcp\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.387404",
    "source_file": "show-service-compound-tcp.html"
  }
}
```