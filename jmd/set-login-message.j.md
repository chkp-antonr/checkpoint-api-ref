...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-login-message",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-login-message": {
      "description": "",
      "request": "POST {{server}}/set-login-message\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"show-message\" : \"true\",\n  \"header\" : \"Warning\",\n  \"message\" : \"Unauthorized access of this server is prohibited and punished by law\",\n  \"warning\" : \"true\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:17.868392",
    "source_file": "set-login-message.html"
  }
}
```