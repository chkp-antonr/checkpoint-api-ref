...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-administrator",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      },
      {
        ...
        "description": "Format: YYYY-MM-DD. If you configure an expiration for an administrator user, then the user is not logged out automatically. Only a new login is blocked.",
        "type": "string",
        "required": false
      },
      {
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.506997",
    "source_file": "add-administrator.html"
  }
}
```