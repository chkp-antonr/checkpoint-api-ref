...
```json
{
  "command": "show-azure-ads",
  "description": "Retrieve existing Microsoft Entra ID Servers (formerly, Azure AD). Reply will not contain the sensitive properties application key and password.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-azure-ads",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-azure-ads-objects": {
      "description": "Show All Microsoft Azure Active Directories.Use the show-task command to check the progress of the task. Output below is the output of the show-task command.",
      "request": "POST {{server}}/show-azure-ads\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.146384",
    "source_file": "show-azure-ads.html"
  }
}
```