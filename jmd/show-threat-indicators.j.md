...
```json
{
  "command": "show-threat-indicators",
  "description": "Display a list of Threat-Indicators.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-threat-indicators",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-threat-indicators": {
      ...
      "request": "POST {{server}}/show-threat-indicators\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.795217",
    "source_file": "show-threat-indicators.html"
  }
}
```