...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-threat-exception",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-threat-exception": {
      ...
      "request": "POST {{server}}/set-threat-exception\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Exception Rule\",\n  \"layer\" : \"New Layer 1\",\n  \"rule-number\" : 1,\n  \"new-name\" : \"Last rule\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:20.689779",
    "source_file": "set-threat-exception.html"
  }
}
```