...
```json
{
  "command": "show-identity-tags",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-identity-tags",
    "headers": [
      {
        "name": "Content-Type",
