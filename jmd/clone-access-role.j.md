...
```json
{
  "command": "clone-access-role",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-access-role",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-access-role": {
      "description": "",
      "request": "POST {{server}}/clone-access-role\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"New Access Role 1\",\n  \"users\" : \"all identified\",\n  \"machines\" : \"any\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:12.276899",
    "source_file": "clone-access-role.html"
  }
}
```