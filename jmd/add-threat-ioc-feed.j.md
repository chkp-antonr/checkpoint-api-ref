...
```json
{
  "command": "add-threat-ioc-feed",
  "description": "Create a new threat IOC feed.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-threat-ioc-feed",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-threat-ioc-feed (With Check Point format/STIX Settings)": {
      "description": "Adding a simple threat IOC feed",
      "request": "POST {{server}}/add-threat-ioc-feed\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"ioc_feed\",\n  \"feed-url\" : \"https://www.feedsresource.com/resource\",\n  \"action\" : \"prevent\"\n}",
      "response": ""
    },
    "add-threat-ioc-feed (With Customer Settings)": {
      "description": "Adding a threat IOC feed (With Customer Settings)",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:09.749766",
    "source_file": "add-threat-ioc-feed.html"
  }
}
```