# show-internal-trusted-ca

```json
{
  "command": "show-internal-trusted-ca",
  "description": "Retrieve existing Internal CA object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-internal-trusted-ca",
    "headers": [
      {
        "name": "Content-Type",
