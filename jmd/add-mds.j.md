...
{
  "command": "add-mds",
  "description": "Create new object of type Multi-Domain Server or Multi-Domain Log Server.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-mds",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.800551",
    "source_file": "add-mds.html"
  }
}
```