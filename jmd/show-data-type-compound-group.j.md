# show-data-type-compound-group

```json
{
  "command": "show-data-type-compound-group",
  "description": "Retrieve existing Compound Data Type Group object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-type-compound-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-type-compound-group": {
      "description": "",
      "request": "POST {{server}}/show-data-type-compound-group\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"compound-group-obj\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.718750",
    "source_file": "show-data-type-compound-group.html"
  }
}
```