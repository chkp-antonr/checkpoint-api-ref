...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-simple-gateway",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-simple-gateway (Enhanced Link Selection Interfaces)": {
      "description": "Displays a gateway with enhanced link selection interfaces",
      "request": "POST {{server}}/show-simple-gateway\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Gateway_2_version_R82\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.318230",
    "source_file": "show-simple-gateway.html"
  }
}
```