...
```json
{
  "command": "show-threat-profiles",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-threat-profiles",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-threat-profiles": {
      "description": "",
      "request": "POST {{server}}/show-threat-profiles\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.913009",
    "source_file": "show-threat-profiles.html"
  }
}
```