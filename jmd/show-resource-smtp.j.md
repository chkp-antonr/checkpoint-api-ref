...
```json
{
  "command": "show-resource-smtp",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-resource-smtp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-resource-smtp": {
      "description": "",
      "request": "POST {{server}}/show-resource-smtp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newSmtpResource\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.055058",
    "source_file": "show-resource-smtp.html"
  }
}
```