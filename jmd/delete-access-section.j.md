...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/delete-access-section",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "delete-access-section": {
      "description": "",
      "request": "POST {{server}}/delete-access-section\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"layer\" : \"Network\",\n  \"name\" : \"New Section 2\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:14.195093",
    "source_file": "delete-access-section.html"
  }
}
```