...
```json
{
  "command": "clone-resource-uri",
  "description": "Clone existing object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-resource-uri",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-resource-uri": {
      "description": "",
      "request": "POST {{server}}/clone-resource-uri\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"apiURI\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.265955",
    "source_file": "clone-resource-uri.html"
  }
}
```