...
```json
{
  "command": "add-if-map-server",
  "description": "Create new IF-MAP server.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-if-map-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.479617",
    "source_file": "add-if-map-server.html"
  }
}
```