...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/uninstall-software-package",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "uninstall-software-package": {
      "description": "",
      "request": "POST {{server}}/uninstall-software-package\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Check_Point_R80_40_JHF_MCD_DEMO_019_MAIN_Bundle_T1_VISIBLE_FULL.tgz\",\n  \"targets.1\" : \"corporate-gateway\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.869247",
    "source_file": "uninstall-software-package.html"
  }
}
```