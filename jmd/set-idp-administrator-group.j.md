# set-idp-administrator-group

```json
{
  "command": "set-idp-administrator-group",
  "description": "Edit existing Identity Provider administrators group using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-idp-administrator-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:17.593816",
    "source_file": "set-idp-administrator-group.html"
  }
}
```