# show-cp-trusted-ca-certificate

```json
{
  "command": "show-cp-trusted-ca-certificate",
  "description": "Retrieve existing Check Point trusted CA certificate using name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-cp-trusted-ca-certificate",
    "headers": [
      {
        "name": "Content-Type",
