...
```json
{
  ...
  "description": "Retrieve existing Remote Access object. Using object name or uid is optional.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-vpn-community-remote-access",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    ...
    "show-vpn-communities-remote-access (with override vpn domains)": {
      "description": "Displays several remote access VPN communities with override VPN domains.",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.619155",
    "source_file": "show-vpn-community-remote-access.html"
  }
}
```