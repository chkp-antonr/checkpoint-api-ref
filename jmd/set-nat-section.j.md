...
```json
{
  "command": "set-nat-section",
  "description": "Edit existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-nat-section",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "set-nat-section": {
      "description": "",
      "request": "POST {{server}}/set-nat-section\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"package\" : \"standard\",\n  \"name\" : \"New Section 1\",\n  \"new-name\" : \"New Section 2\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.471636",
    "source_file": "set-nat-section.html"
  }
}
```