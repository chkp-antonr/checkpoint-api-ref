...
```json
{
  "command": "show-repository-package",
  "description": "Gets repository software packages information.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-repository-package",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.940430",
    "source_file": "show-repository-package.html"
  }
}
```