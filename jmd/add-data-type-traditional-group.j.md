...
```json
{
  "command": "add-data-type-traditional-group",
  "description": "Create new Traditional Group Data Type Object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-data-type-traditional-group",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.869860",
    "source_file": "add-data-type-traditional-group.html"
  }
}
```