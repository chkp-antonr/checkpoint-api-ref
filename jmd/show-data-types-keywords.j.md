...
```json
{
  "command": "show-data-types-keywords",
  "description": "Retrieve all Keywords Data Type objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-types-keywords",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.979588",
    "source_file": "show-data-types-keywords.html"
  }
}
```