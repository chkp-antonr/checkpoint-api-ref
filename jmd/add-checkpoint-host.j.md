...
```json
{
  "command": "add-checkpoint-host",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-checkpoint-host",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.673269",
    "source_file": "add-checkpoint-host.html"
  }
}
```