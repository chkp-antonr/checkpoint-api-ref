# show-smart-task-triggers

```json
{
  "command": "show-smart-task-triggers",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-smart-task-triggers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-smart-task-triggers": {
      "description": "",
      "request": "POST {{server}}/show-smart-task-triggers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.361974",
    "source_file": "show-smart-task-triggers.html"
  }
}
```