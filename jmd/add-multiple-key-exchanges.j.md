...
```json
{
  "command": "add-multiple-key-exchanges",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-multiple-key-exchanges",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    ...
    "add-multiple-key-exchanges (with multiple algorithms)": {
      "description": "Adds a new Multiple Key Exchanges with multiple algorithms options.",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:07.990080",
    "source_file": "add-multiple-key-exchanges.html"
  }
}
```