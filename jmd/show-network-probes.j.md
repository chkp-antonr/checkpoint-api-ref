...
```json
{
  "command": "show-network-probes",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-network-probes",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-network-probes": {
      "description": "Displays several Network Probes.",
      "request": "POST {{server}}/show-network-probes\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0\n}",
      "response": "{\n  \"from\" : 1,\n  \"to\" : 1,\n  \"total\" : 1,\n  \"objects\" : [ {\n    \"uid\" : \"6e82f8d4-9af4-4ee3-a2e2-fb45bddb0358\",\n    \"name\" : \"probe_GW1_http\",\n    \"type\" : \"network-probe\",\n    \"domain\" : {\n      \"uid\" : \"41e821a0-3720-11e3-aa6e-0800200c9fde\",\n      \"name\" : \"SMC User\",\n      \"domain-type\" : \"domain\"\n    },\n    \"icon\" : \"NetworkObjects/NetworkProbe\",\n    \"color\" : \"black\"\n  } ]\n}"
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.480703",
    "source_file": "show-network-probes.html"
  }
}
```