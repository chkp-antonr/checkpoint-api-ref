...
```json
{
  "command": "set-data-type-keywords",
  "description": "Edit existing Keywords Data Type object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-data-type-keywords",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:16.478574",
    "source_file": "set-data-type-keywords.html"
  }
}
```