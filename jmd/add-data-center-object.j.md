...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-data-center-object",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "add-data-center-object with group": {
      "description": "",
      "request": "POST {{server}}/add-data-center-object\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"data-center-name\" : \"vCenter 1\",\n  \"uri\" : \"/Datacenters/VMs/My VM1\",\n  \"name\" : \"VM1 mgmt name\",\n  \"groups\" : [ \"Database VMs Group\" ]\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.729194",
    "source_file": "add-data-center-object.html"
  }
}
```