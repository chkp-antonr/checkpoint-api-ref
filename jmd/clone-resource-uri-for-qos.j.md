...
```json
{
  "command": "clone-resource-uri-for-qos",
  "description": "Clone existing Uri For QoS resource.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/clone-resource-uri-for-qos",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "clone-resource-uri-for-qos": {
      "description": "",
      "request": "POST {{server}}/clone-resource-uri-for-qos\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"newUriForQosResource\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:13.214006",
    "source_file": "clone-resource-uri-for-qos.html"
  }
}
```