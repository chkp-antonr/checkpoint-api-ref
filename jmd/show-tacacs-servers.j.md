...
```json
{
  "command": "show-tacacs-servers",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-tacacs-servers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-tacacs-servers": {
      "description": "",
      "request": "POST {{server}}/show-tacacs-servers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.627665",
    "source_file": "show-tacacs-servers.html"
  }
}
```