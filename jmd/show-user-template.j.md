...
```json
{
  "command": "show-user-template",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-user-template",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-user-template": {
      "description": "",
      "request": "POST {{server}}/show-user-template\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"Default\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:29.277649",
    "source_file": "show-user-template.html"
  }
}
```