...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-global-properties",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-global-properties": {
      "description": "",
      "request": "POST {{server}}/show-global-properties\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.832708",
    "source_file": "show-global-properties.html"
  }
}
```