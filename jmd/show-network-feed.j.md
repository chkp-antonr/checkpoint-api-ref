...
```json
{
  "command": "show-network-feed",
  "description": "Displays a Network Feed.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-network-feed",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-network-feed": {
      "description": "Showing a Network Feed",
      "request": "POST {{server}}/show-network-feed\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"network_feed\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:26.429538",
    "source_file": "show-network-feed.html"
  }
}
```