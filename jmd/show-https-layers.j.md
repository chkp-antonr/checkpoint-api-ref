...
```json
{
  ...
  "description": "Retrieve all HTTPS Inspection layers.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-https-layers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-https-layers": {
      "description": "",
      "request": "POST {{server}}/show-https-layers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.103668",
    "source_file": "show-https-layers.html"
  }
}
```