...
```json
{
  "command": "add-application-site-category",
  "description": "Create new object.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/add-application-site-category",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:06.533555",
    "source_file": "add-application-site-category.html"
  }
}
```