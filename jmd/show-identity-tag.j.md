...
```json
{
  "command": "show-identity-tag",
  "description": "Retrieve existing object using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-identity-tag",
    "headers": [
      {
        "name": "Content-Type",
