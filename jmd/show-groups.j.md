...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-groups",
    "headers": [
      {
        "name": "Content-Type",
    ...
    "body": [
      ...
      {
        "name": "show-as-ranges",
        "description": "When true, the group's matched content is displayed as ranges of IP addresses rather than network objects.Objects that are not represented using IP addresses are presented as objects.The 'members' parameter is omitted from the response and instead the 'ranges' parameter is displayed.",
        "type": "boolean",
        "required": false,
        "default": "false"
      }
  ...
  "examples": {
    "show-groups": {
      "description": "",
      "request": "POST {{server}}/show-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    },
    "show-groups as ranges": {
      "description": "Shows the first 50 groups with each group's matched content displayed as ranges of IP addresses, and not as Check Point Objects.",
      "request": "POST {{server}}/show-groups\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"full\",\n  \"show-as-ranges\" : \"true\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.921799",
    "source_file": "show-groups.html"
  }
}
```