# show-checkpoint-hosts

```json
{
  "command": "show-checkpoint-hosts",
  "description": "Retrieve all objects.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-checkpoint-hosts",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-checkpoint-hosts": {
      "description": "",
      "request": "POST {{server}}/show-checkpoint-hosts\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 10\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.281930",
    "source_file": "show-checkpoint-hosts.html"
  }
}
```