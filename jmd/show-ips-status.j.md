...
```json
{
  ...
  "description": "",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-ips-status",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "response": {
    "success": [
      ...
      {
        "name": "installed-version-creation-time",
        "description": "",
        "type": "Object",
        "required": false
      },
  ...
  "examples": {
    "show-ips-status": {
      ...
      "request": "POST {{server}}/show-ips-status\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{ }",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.632524",
    "source_file": "show-ips-status.html"
  }
}
```