...
```json
{
  ...
  "description": "Shows the entire Access Rules layer. This layer is divided into sections. An Access Rule may be within a section, or independent of a section (in which case it is said to be under the \"global\" section). The reply features a list of objects. Each object may be a section of the layer, with all its rules in, or a rule itself, for the case of rules which are under the global section. An optional \"filter\" field may be added in order to filter out only those rules that match a search criteria.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-access-rulebase",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-access-rulebase": {
      ...
      "request": "POST {{server}}/show-access-rulebase\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"offset\" : 0,\n  \"limit\" : 20,\n  \"name\" : \"Network\",\n  \"details-level\" : \"standard\",\n  \"use-object-dictionary\" : true\n}",
    ...
    "show-access-rulebase with filter by rule UID": {
      "description": "Shows an Access Control Rulebase filtered by a predefined list of rule UID's.Note: this filter is supported with API version 1.4 and above.",
    ...
    "show-access-rulebase-with-filter-expand-group-members": {
      "description": "For a given group, finds the Access Control Rules that match at least one member of the group. In this example, \"HR-Managers-Server\" object is a member of the \"HR\" group, and therefore rules which contain this object will not be matched.",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:22.688083",
    "source_file": "show-access-rulebase.html"
  }
}
```