# show-idp-administrator-group

```json
{
  "command": "show-idp-administrator-group",
  "description": "Retrieve existing Identity Provider administrators group using object name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-idp-administrator-group",
    "headers": [
      {
        "name": "Content-Type",
