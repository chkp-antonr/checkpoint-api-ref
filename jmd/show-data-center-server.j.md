...
```json
{
  "command": "show-data-center-server",
  "description": "Retrieve existing Data Center Server using name or uid.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-data-center-server",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-data-center-server": {
      "description": "",
      "request": "POST {{server}}/show-data-center-server\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"vCenter 1\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:23.668913",
    "source_file": "show-data-center-server.html"
  }
}
```