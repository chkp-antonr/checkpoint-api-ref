...
```json
{
  "command": "set-lsm-gateway",
  "description": "Edit existing LSM Gateway.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/set-lsm-gateway",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:18.026192",
    "source_file": "set-lsm-gateway.html"
  }
}
```