...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-services-rpc",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-services-rpc": {
      "description": "",
      "request": "POST {{server}}/show-services-rpc\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.734220",
    "source_file": "show-services-rpc.html"
  }
}
```