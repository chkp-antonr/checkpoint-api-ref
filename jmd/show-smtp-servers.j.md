...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-smtp-servers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-smtp-servers": {
      "description": "",
      "request": "POST {{server}}/show-smtp-servers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 50,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:28.484484",
    "source_file": "show-smtp-servers.html"
  }
}
```