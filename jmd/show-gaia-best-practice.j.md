...
```json
{
  "command": "show-gaia-best-practice",
  "description": "Show a Gaia Best Practice.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-gaia-best-practice",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-gaia-best-practice": {
      "description": "Show a Gaia Best Practice - Either user-defined (created by the user) or default (created by Checkpoint)",
      "request": "POST {{server}}/show-gaia-best-practice\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"best-practice-id\" : \"os001\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:24.379551",
    "source_file": "show-gaia-best-practice.html"
  }
}
```