...
```json
{
  "command": "show-securemote-dns-servers",
  "description": "Retrieve all SecuRemote DNS servers.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-securemote-dns-servers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show securemote-dns-servers": {
      "description": "Retrieve all Securemote DNS servers.",
      "request": "POST {{server}}/show-securemote-dns-servers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 5,\n  \"offset\" : 0,\n  \"details-level\" : \"full\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.256735",
    "source_file": "show-securemote-dns-servers.html"
  }
}
```