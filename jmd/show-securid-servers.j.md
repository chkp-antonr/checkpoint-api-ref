...
```json
{
  "command": "show-securid-servers",
  "description": "Retrieve all SecurID servers.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-securid-servers",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show securid-servers": {
      "description": "Shows SecurID Servers.",
      "request": "POST {{server}}/show-securid-servers\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 5,\n  \"offset\" : 0,\n  \"details-level\" : \"full\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.284402",
    "source_file": "show-securid-servers.html"
  }
}
```