...
```json
{
  "command": "show-lsm-cluster",
  "description": "Show LSM Cluster.",
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-lsm-cluster",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-lsm-cluster": {
      "description": "",
      "request": "POST {{server}}/show-lsm-cluster\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"name\" : \"lsm_cluster\"\n}",
      "response": ""
    }
  },
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:25.891936",
    "source_file": "show-lsm-cluster.html"
  }
}
```