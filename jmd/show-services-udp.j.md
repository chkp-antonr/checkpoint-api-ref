...
```json
{
  ...
  "request": {
    "url": "POST https://<mgmt-server>:<port>/web_api/show-services-udp",
    "headers": [
      {
        "name": "Content-Type",
  ...
  "examples": {
    "show-services-udp": {
      "description": "",
      "request": "POST {{server}}/show-services-udp\nContent-Type: application/json\nX-chkp-sid: {{session}}\n\n{\n  \"limit\" : 10,\n  \"offset\" : 0,\n  \"details-level\" : \"standard\"\n}",
  ...
  "metadata": {
    "version": "2.0.1",
    "extracted_at": "2025-10-05T21:36:27.777176",
    "source_file": "show-services-udp.html"
  }
}
```