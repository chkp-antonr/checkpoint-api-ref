...
**Method:** `POST`
**URL:** `{{server}}/v2.0.1/set-smart-task`

## Description

Sets a SmartTask that will run after install policy and send a web request to the target URL.
...
### Example 1: set-smart-task that sends a web request after policy installations
**Status:** `200 OK`
