...
**Method:** `POST`
**URL:** `{{server}}/v2.0.1/add-smart-task`

## Description

Adds a SmartTask that will run after install policy and send a web request to the target URL.
...
### Example 1: add-smart-task that sends a web request after policy installations
**Status:** `200 OK`
