...
**Method:** `POST`
**URL:** `{{server}}/v2.0.1/show-identity-providers`

## Description

Shows identity providers.
...
### Example 1: show identity-providers
**Status:** `200 OK`
  ...
  "objects": [
    {
      ...
      "gateway": {
        ...
        "send-alerts-to-server": [
          "mgmt_172.23.48.144mgmt_vs_8210_api_main_take_37MGMTdorbe"
        ],
        "send-logs-to-server": [
          "mgmt_172.23.48.144mgmt_vs_8210_api_main_take_37MGMTdorbe"
        ],
      ...
      "reply-urls": [
        "https://1.1.1.1/connect/spPortal/ACS/Login/0e4cae10-43f9-4b66-87a8-931d5285df11"
      ],
    ...
    },
    {
      ...
      "reply-urls": [
        "https://172.23.48.144/cpmws/saml/acs/sso"
      ],
