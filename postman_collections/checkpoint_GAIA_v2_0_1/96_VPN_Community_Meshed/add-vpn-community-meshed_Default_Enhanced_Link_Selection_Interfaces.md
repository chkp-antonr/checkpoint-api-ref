...
Adds a new VPN Meshed Community with default Enhanced Link Selection Interfaces configuration
...
### Example 1: add-vpn-community-meshed (Default Enhanced Link Selection Interfaces)
**Status:** `200 OK`
