...
**Method:** `POST`
**URL:** `{{server}}/v2.0.1/set-vpn-community-meshed`

## Description

Modifies an existing VPN Meshed Community with Enhanced Link Selection Interfaces (Add Action)
...
### Example 1: set-vpn-community-meshed (add Enhanced Link Selection Interfaces)
**Status:** `200 OK`
...
```javascript
{
  ...
  "meta-info": {
    ...
    "last-modify-time": {
      "posix": 1717513052187,
      "iso-8601": "2024-06-04T17:57+0300"
    },
