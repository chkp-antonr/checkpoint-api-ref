...
Modifies an existing VPN Meshed Community with Enhanced Link Selection Interfaces (Remove Action)
...
### Example 1: set-vpn-community-meshed (remove Enhanced Link Selection Interfaces)
**Status:** `200 OK`
