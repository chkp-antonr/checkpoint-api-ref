...
Modifies an existing VPN Star Community with Enhanced Link Selection Interfaces (Remove Action)
...
### Example 1: set-vpn-community-star (remove Enhanced Link Selection Interfaces)
**Status:** `200 OK`
