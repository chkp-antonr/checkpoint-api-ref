...
Adds a new VPN Star Community with user defined Enhanced Link Selection Interfaces configuration
...
### Example 1: add-vpn-community-star (User Defined Enhanced Link Selection Interfaces)
**Status:** `200 OK`
