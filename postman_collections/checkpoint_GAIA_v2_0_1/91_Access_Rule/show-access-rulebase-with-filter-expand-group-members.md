...
For a given group, finds the Access Control Rules that match at least one member of the group. In this example, "HR-Managers-Server" object is a member of the "HR" group, and therefore rules which contain this object will not be matched.
...
### Example 1: show-access-rulebase-with-filter-expand-group-members
**Status:** `200 OK`
