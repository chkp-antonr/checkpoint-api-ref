...
Modifies an existing gateway with Enhanced Link Selection Interfaces (Remove Action)
...
### Example 1: set-simple-gateway (remove Enhanced Link Selection Interfaces)
**Status:** `200 OK`
