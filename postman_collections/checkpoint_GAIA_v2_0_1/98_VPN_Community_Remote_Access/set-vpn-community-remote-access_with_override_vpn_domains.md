...
**Method:** `POST`
**URL:** `{{server}}/v2.0.1/set-vpn-community-remote-access`

## Description

Edits remote access VPN community with override VPN domains.
...
### Example 1: set-vpn-community-remote-access (with override vpn domains)
**Status:** `200 OK`
