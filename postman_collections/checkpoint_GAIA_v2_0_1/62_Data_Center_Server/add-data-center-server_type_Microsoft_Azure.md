...
Add data center server of type Microsoft Azure,<br>Use the show-task command to check the progress of the task. Output below is the output of the show-task command.
...
### Example 1: add-data-center-server type Microsoft Azure
**Status:** `200 OK`
