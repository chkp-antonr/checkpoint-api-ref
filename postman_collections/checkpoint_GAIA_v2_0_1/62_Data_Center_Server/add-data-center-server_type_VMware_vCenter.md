...
Add data center server of type vCenter,<br>Use the show-task command to check the progress of the task. Output below is the output of the show-task command.
...
### Example 1: add-data-center-server type VMware vCenter
**Status:** `200 OK`
