...
Set any argument for a data center server of type OpenStack,<br>Use the show-task command to check the progress of the task. Output below is the output of the show-task command.
...
### Example 1: set-data-center-server type OpenStack
**Status:** `200 OK`
