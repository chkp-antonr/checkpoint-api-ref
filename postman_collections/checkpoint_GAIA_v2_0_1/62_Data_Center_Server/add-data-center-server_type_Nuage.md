...
Add data center server of type Nuage,<br>Acceptable format for the hostname argument: https://&lt;host&gt;:&lt;port&gt;/nuage/api/&lt;version&gt;.<br>Use the show-task command to check the progress of the task. Output below is the output of the show-task command.
...
### Example 1: add-data-center-server type Nuage
**Status:** `200 OK`
