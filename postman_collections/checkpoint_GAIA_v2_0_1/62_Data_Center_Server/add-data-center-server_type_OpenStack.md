...
Add data center server of type OpenStack,<br>Acceptable format for the hostname argument: http(s)://&lt;host&gt;:&lt;port&gt;/&lt;version&gt;.<br>Use the show-task command to check the progress of the task. Output below is the output of the show-task command.
...
### Example 1: add-data-center-server type OpenStack
**Status:** `200 OK`
