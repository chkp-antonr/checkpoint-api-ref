...
**Collection:** Web API (version 2.0.1) > 145 Identity Provider Administrator Group
**Method:** `POST`
**URL:** `{{server}}/v2.0.1/show-idp-administrator-group`
...
### Example 1: show-idp-administrator-group by name
**Status:** `200 OK`
