# show voip-domain-mgcp-call-agent

**Collection:** Web API (version 2.1) > 26 VoIP Domain MGCP Call Agent
**Method:** `POST`
**URL:** `{{server}}/v2.1/show-voip-domain-mgcp-call-agent`

## Description

Shows voip domain mgcp call agent.
...
### Example 1: show voip-domain-mgcp-call-agent
**Status:** `200 OK`
