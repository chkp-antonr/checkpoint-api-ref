# set-vpn-community-meshed (dynamic routing settings)
...
Modifies an existing VPN Meshed Community with dynamic routing settings
...
### Example 1: set-vpn-community-meshed (dynamic routing settings)
**Status:** `200 OK`
...
```javascript
{
  ...
  "meta-info": {
    ...
    "last-modify-time": {
      "posix": 1753969869318,
      "iso-8601": "2025-07-31T16:51+0300"
    },
