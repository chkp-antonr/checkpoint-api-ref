# add-vpn-community-meshed (dynamic routing settings)
...
Adds a new Route Based Meshed VPN Community with dynamic routing settings
...
### Example 1: add-vpn-community-meshed (dynamic routing settings)
**Status:** `200 OK`

**Body:**
```javascript
{
  "uid": "d058ac8a-a93b-4d78-8e37-f04ff29f904b",
  "name": "RouteBased_Meshed_VPN_Community",
  ...
  "meta-info": {
    ...
    "last-modify-time": {
      "posix": 1753971492240,
      "iso-8601": "2025-07-31T17:18+0300"
    },
