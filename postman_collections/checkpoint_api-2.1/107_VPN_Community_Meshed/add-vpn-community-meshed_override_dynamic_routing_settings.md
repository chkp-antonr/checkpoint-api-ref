# add-vpn-community-meshed (override dynamic routing settings)
...
Adds a new Route Based Meshed VPN Community with override dynamic routing settings
...
### Example 1: add-vpn-community-meshed (override dynamic routing settings)
**Status:** `200 OK`

**Body:**
```javascript
{
  "uid": "f34bfb3b-d2c5-44e2-aab4-ed6dd61896bb",
  "name": "RouteBased_Meshed_VPN_Community",
  ...
  "meta-info": {
    ...
    "last-modify-time": {
      "posix": 1753968336412,
      "iso-8601": "2025-07-31T16:25+0300"
    },
