# set-vpn-community-meshed (to route based)
...
Modifies an existing Meshed VPN Community to use route-based routing mode
...
### Example 1: set-vpn-community-meshed (to route based)
**Status:** `200 OK`

**Body:**
```javascript
{
  "uid": "48aaacde-b76a-4063-b832-fcd02c6fecbd",
  "name": "VPN_Community_1",
  ...
  "meta-info": {
    ...
    "last-modify-time": {
      "posix": 1733837212021,
      "iso-8601": "2024-12-10T15:26+0200"
    },
    "last-modifier": "WEB_API",
    "creation-time": {
      "posix": 1733836678120,
      "iso-8601": "2024-12-10T15:17+0200"
    },
    "creator": "WEB_API"
  },
  "available-actions": {
  ...
  "ike-phase-1": {
    ...
    "multiple-key-exchanges": {
      ...
      "meta-info": {
        ...
        "last-modify-time": {
          "posix": 1733226684395,
          "iso-8601": "2024-12-03T13:51+0200"
        },
  ...
  "gateways": [
    {
      "uid": "a13e945c-13db-456a-a35b-c2e78423240a",
      "name": "gateway_2",
      "type": "simple-gateway",
      "domain": {
        "uid": "41e821a0-3720-11e3-aa6e-0800200c9fde",
    ...
    {
      "uid": "9915327c-33db-4a0d-8c2f-abec0acb0140",
      "name": "gateway_1",
      "type": "simple-gateway",
      "domain": {
        "uid": "41e821a0-3720-11e3-aa6e-0800200c9fde",
