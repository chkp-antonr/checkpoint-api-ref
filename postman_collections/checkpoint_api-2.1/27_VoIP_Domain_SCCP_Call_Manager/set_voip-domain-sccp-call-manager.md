# set voip-domain-sccp-call-manager

**Collection:** Web API (version 2.1) > 27 VoIP Domain SCCP Call Manager
**Method:** `POST`
**URL:** `{{server}}/v2.1/set-voip-domain-sccp-call-manager`

## Description

Edits end point of voip domain sccp call manager.
...
### Example 1: set voip-domain-sccp-call-manager
**Status:** `200 OK`
...
```javascript
{
  ...
  "meta-info": {
    ...
    "last-modify-time": {
      "posix": 1753776864268,
      "iso-8601": "2025-07-29T11:14+0300"
    },
    "last-modifier": "aa",
    "creation-time": {
      "posix": 1753776654165,
