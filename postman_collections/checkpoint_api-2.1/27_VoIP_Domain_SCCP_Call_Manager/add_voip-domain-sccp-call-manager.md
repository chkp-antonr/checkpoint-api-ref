# add voip-domain-sccp-call-manager

**Collection:** Web API (version 2.1) > 27 VoIP Domain SCCP Call Manager
**Method:** `POST`
**URL:** `{{server}}/v2.1/add-voip-domain-sccp-call-manager`

## Description

Add new voip domain sccp call manager
...
### Example 1: add voip-domain-sccp-call-manager
**Status:** `200 OK`
