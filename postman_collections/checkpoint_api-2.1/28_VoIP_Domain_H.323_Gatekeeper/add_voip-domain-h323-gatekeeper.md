# add voip-domain-h323-gatekeeper

**Collection:** Web API (version 2.1) > 28 VoIP Domain H.323 Gatekeeper
**Method:** `POST`
**URL:** `{{server}}/v2.1/add-voip-domain-h323-gatekeeper`

## Description

Add new voip domain h323 gatekeeper
...
### Example 1: add voip-domain-h323-gatekeeper
**Status:** `200 OK`
