# show voip-domain-h323-gateway

**Collection:** Web API (version 2.1) > 29 VoIP Domain H.323 Gateway
**Method:** `POST`
**URL:** `{{server}}/v2.1/show-voip-domain-h323-gateway`

## Description

Show existing voip domain h323 gateway
...
### Example 1: show voip-domain-h323-gateway
**Status:** `200 OK`
