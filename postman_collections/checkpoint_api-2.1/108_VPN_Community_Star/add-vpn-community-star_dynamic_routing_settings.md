# add-vpn-community-star (dynamic routing settings)
...
Adds a new Route Based Star VPN Community with dynamic routing settings
...
### Example 1: add-vpn-community-star (dynamic routing settings)
**Status:** `200 OK`

**Body:**
```javascript
{
  "uid": "56ea7c2a-505d-4abb-beee-eb427d0ea623",
  "name": "RouteBased_Star_VPN_Community",
  ...
  "meta-info": {
    ...
    "last-modify-time": {
      "posix": 1753969192063,
      "iso-8601": "2025-07-31T16:39+0300"
    },
