...
Modifies an existing VPN Star Community with Enhanced Link Selection Interfaces (Set Action)
...
### Example 1: set-vpn-community-star (replace Enhanced Link Selection Interfaces)
**Status:** `200 OK`
