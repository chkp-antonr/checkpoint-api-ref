# set-vpn-community-star (dynamic routing settings)
...
Modifies an existing VPN Star Community with dynamic routing settings
...
### Example 1: set-vpn-community-star (dynamic routing settings)
**Status:** `200 OK`
...
```javascript
{
  ...
  "meta-info": {
    ...
    "last-modify-time": {
      "posix": 1753970001843,
      "iso-8601": "2025-07-31T16:53+0300"
    },
